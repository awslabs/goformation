...
// Dashboard_InnerFilter AWS CloudFormation Resource (AWS::QuickSight::Dashboard.InnerFilter)
...
type Dashboard_InnerFilter struct {
	...
	CategoryInnerFilter *Dashboard_CategoryInnerFilter `json:"CategoryInnerFilter,omitempty"`
...
func (r *Dashboard_InnerFilter) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.InnerFilter"
}
