...
// JobDefinition_EfsVolumeConfiguration AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.EfsVolumeConfiguration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-efsvolumeconfiguration.html
...
func (r *JobDefinition_EfsVolumeConfiguration) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.EfsVolumeConfiguration"
}
