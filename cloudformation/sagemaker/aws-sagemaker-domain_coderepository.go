...
// Domain_CodeRepository AWS CloudFormation Resource (AWS::SageMaker::Domain.CodeRepository)
...
func (r *Domain_CodeRepository) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.CodeRepository"
}
