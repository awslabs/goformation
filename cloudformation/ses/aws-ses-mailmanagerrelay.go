...
// MailManagerRelay AWS CloudFormation Resource (AWS::SES::MailManagerRelay)
...
type MailManagerRelay struct {
	...
	Authentication *MailManagerRelay_RelayAuthentication `json:"Authentication"`

	// RelayName AWS CloudFormation Property
	// Required: false
...
func (r *MailManagerRelay) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRelay"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerRelay) MarshalJSON() ([]byte, error) {
	type Properties MailManagerRelay
...
func (r *MailManagerRelay) UnmarshalJSON(b []byte) error {
	type Properties MailManagerRelay
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerRelay(*res.Properties)
	}
