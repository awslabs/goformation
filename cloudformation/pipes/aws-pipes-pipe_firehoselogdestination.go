...
// Pipe_FirehoseLogDestination AWS CloudFormation Resource (AWS::Pipes::Pipe.FirehoseLogDestination)
...
func (r *Pipe_FirehoseLogDestination) AWSCloudFormationType() string {
	return "AWS::Pipes::Pipe.FirehoseLogDestination"
}
