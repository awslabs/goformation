...
func (t *CloudFormationTemplate) GetAllAWSCloudWatchAlarmResources () map[string]AWSCloudWatchAlarm {
...
func (t *CloudFormationTemplate) GetAWSCloudWatchAlarmWithName (name string) (AWSCloudWatchAlarm, error) {
