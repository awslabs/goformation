...
type Dashboard_TotalAggregationOption struct {
	...
	TotalAggregationFunction *Dashboard_TotalAggregationFunction `json:"TotalAggregationFunction"`
...
func (r *Dashboard_TotalAggregationOption) AWSCloudFormationType() string {
