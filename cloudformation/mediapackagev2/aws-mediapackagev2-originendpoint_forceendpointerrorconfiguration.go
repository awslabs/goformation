...
// OriginEndpoint_ForceEndpointErrorConfiguration AWS CloudFormation Resource (AWS::MediaPackageV2::OriginEndpoint.ForceEndpointErrorConfiguration)
...
type OriginEndpoint_ForceEndpointErrorConfiguration struct {
	...
	// EndpointErrorConditions AWS CloudFormation Property
	// Required: false
...
func (r *OriginEndpoint_ForceEndpointErrorConfiguration) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::OriginEndpoint.ForceEndpointErrorConfiguration"
}
