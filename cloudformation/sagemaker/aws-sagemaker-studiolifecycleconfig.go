...
// StudioLifecycleConfig AWS CloudFormation Resource (AWS::SageMaker::StudioLifecycleConfig)
...
type StudioLifecycleConfig struct {
	...
	// StudioLifecycleConfigAppType AWS CloudFormation Property
	// Required: true
	...
	// StudioLifecycleConfigContent AWS CloudFormation Property
	// Required: true
	...
	// StudioLifecycleConfigName AWS CloudFormation Property
	// Required: true
...
func (r *StudioLifecycleConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::StudioLifecycleConfig"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StudioLifecycleConfig) MarshalJSON() ([]byte, error) {
	type Properties StudioLifecycleConfig
...
func (r *StudioLifecycleConfig) UnmarshalJSON(b []byte) error {
	type Properties StudioLifecycleConfig
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = StudioLifecycleConfig(*res.Properties)
	}
