...
type AWSApplicationAutoScalingScalingPolicy struct {
    ...
    StepScalingPolicyConfiguration AWSApplicationAutoScalingScalingPolicyStepScalingPolicyConfiguration `json:"StepScalingPolicyConfiguration"`
    ...
    TargetTrackingScalingPolicyConfiguration AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfiguration `json:"TargetTrackingScalingPolicyConfiguration"`
