...
type Subscriber struct {
	...
	// DataLakeArn AWS CloudFormation Property
	// Required: true
	...
	DataLakeArn string `json:"DataLakeArn"`
	...
	Sources []Subscriber_Source `json:"Sources"`

	// SubscriberDescription AWS CloudFormation Property
	// Required: false
	...
	// SubscriberIdentity AWS CloudFormation Property
	// Required: true
	...
	SubscriberIdentity *Subscriber_SubscriberIdentity `json:"SubscriberIdentity"`

	// SubscriberName AWS CloudFormation Property
	// Required: true
...
func (r *Subscriber) AWSCloudFormationType() string {
	return "AWS::SecurityLake::Subscriber"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Subscriber) MarshalJSON() ([]byte, error) {
	type Properties Subscriber
...
func (r *Subscriber) UnmarshalJSON(b []byte) error {
	type Properties Subscriber
	res := &struct {
		Type                string
		Properties          *Properties
