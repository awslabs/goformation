...
// Template_QueryExecutionOptions AWS CloudFormation Resource (AWS::QuickSight::Template.QueryExecutionOptions)
...
func (r *Template_QueryExecutionOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.QueryExecutionOptions"
}
