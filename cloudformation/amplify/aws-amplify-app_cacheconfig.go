...
// App_CacheConfig AWS CloudFormation Resource (AWS::Amplify::App.CacheConfig)
...
func (r *App_CacheConfig) AWSCloudFormationType() string {
	return "AWS::Amplify::App.CacheConfig"
}
