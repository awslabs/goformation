...
// Scraper_EksConfiguration AWS CloudFormation Resource (AWS::APS::Scraper.EksConfiguration)
...
func (r *Scraper_EksConfiguration) AWSCloudFormationType() string {
	return "AWS::APS::Scraper.EksConfiguration"
}
