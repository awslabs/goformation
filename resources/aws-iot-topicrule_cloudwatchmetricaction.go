...
type AWSIoTTopicRuleCloudwatchMetricAction struct {
...
func (r *AWSIoTTopicRuleCloudwatchMetricAction) AWSCloudFormationType() string {
    return "AWS::IoT::TopicRule.CloudwatchMetricAction"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSIoTTopicRuleCloudwatchMetricAction) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}