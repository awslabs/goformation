...
// Space_SpaceCodeEditorAppSettings AWS CloudFormation Resource (AWS::SageMaker::Space.SpaceCodeEditorAppSettings)
...
func (r *Space_SpaceCodeEditorAppSettings) AWSCloudFormationType() string {
	return "AWS::SageMaker::Space.SpaceCodeEditorAppSettings"
}
