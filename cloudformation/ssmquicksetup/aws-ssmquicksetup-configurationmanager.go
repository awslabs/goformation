...
// ConfigurationManager AWS CloudFormation Resource (AWS::SSMQuickSetup::ConfigurationManager)
...
type ConfigurationManager struct {
	...
	// ConfigurationDefinitions AWS CloudFormation Property
	// Required: true
	...
	ConfigurationDefinitions []ConfigurationManager_ConfigurationDefinition `json:"ConfigurationDefinitions"`
...
func (r *ConfigurationManager) AWSCloudFormationType() string {
	return "AWS::SSMQuickSetup::ConfigurationManager"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfigurationManager) MarshalJSON() ([]byte, error) {
	type Properties ConfigurationManager
...
func (r *ConfigurationManager) UnmarshalJSON(b []byte) error {
	type Properties ConfigurationManager
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ConfigurationManager(*res.Properties)
	}
