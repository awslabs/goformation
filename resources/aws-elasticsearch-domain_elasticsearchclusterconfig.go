...
type AWSElasticsearchDomainElasticsearchClusterConfig struct {
...
func (r *AWSElasticsearchDomainElasticsearchClusterConfig) AWSCloudFormationType() string {
	return "AWS::Elasticsearch::Domain.ElasticsearchClusterConfig"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSElasticsearchDomainElasticsearchClusterConfig) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
