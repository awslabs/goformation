...
// Flow_FlowCondition AWS CloudFormation Resource (AWS::Bedrock::Flow.FlowCondition)
...
func (r *Flow_FlowCondition) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.FlowCondition"
}
