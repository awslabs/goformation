...
func (t *CloudFormationTemplate) GetAllAWSRoute53RecordSetGroupResources() map[string]AWSRoute53RecordSetGroup {
...
func (t *CloudFormationTemplate) GetAWSRoute53RecordSetGroupWithName(name string) (AWSRoute53RecordSetGroup, error) {
