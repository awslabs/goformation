...
// DeliveryStream_SnowflakeRetryOptions AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.SnowflakeRetryOptions)
...
func (r *DeliveryStream_SnowflakeRetryOptions) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.SnowflakeRetryOptions"
}
