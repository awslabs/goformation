...
// MailManagerRuleSet_ReplaceRecipientAction AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.ReplaceRecipientAction)
...
type MailManagerRuleSet_ReplaceRecipientAction struct {
	...
	// ReplaceWith AWS CloudFormation Property
	// Required: false
...
func (r *MailManagerRuleSet_ReplaceRecipientAction) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.ReplaceRecipientAction"
}
