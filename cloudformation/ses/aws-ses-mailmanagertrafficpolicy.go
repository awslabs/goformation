...
// MailManagerTrafficPolicy AWS CloudFormation Resource (AWS::SES::MailManagerTrafficPolicy)
...
type MailManagerTrafficPolicy struct {
	...
	// MaxMessageSizeBytes AWS CloudFormation Property
	// Required: false
	...
	// PolicyStatements AWS CloudFormation Property
	// Required: true
	...
	PolicyStatements []MailManagerTrafficPolicy_PolicyStatement `json:"PolicyStatements"`
	...
	// TrafficPolicyName AWS CloudFormation Property
	// Required: false
...
func (r *MailManagerTrafficPolicy) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerTrafficPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerTrafficPolicy) MarshalJSON() ([]byte, error) {
	type Properties MailManagerTrafficPolicy
...
func (r *MailManagerTrafficPolicy) UnmarshalJSON(b []byte) error {
	type Properties MailManagerTrafficPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerTrafficPolicy(*res.Properties)
	}
