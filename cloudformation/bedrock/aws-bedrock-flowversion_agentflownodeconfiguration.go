...
// FlowVersion_AgentFlowNodeConfiguration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.AgentFlowNodeConfiguration)
...
type FlowVersion_AgentFlowNodeConfiguration struct {
	...
	// AgentAliasArn AWS CloudFormation Property
	// Required: true
...
func (r *FlowVersion_AgentFlowNodeConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.AgentFlowNodeConfiguration"
}
