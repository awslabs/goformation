...
func (t *CloudFormationTemplate) GetAllAWSSSMDocumentResources () map[string]AWSSSMDocument {
...
func (t *CloudFormationTemplate) GetAWSSSMDocumentWithName (name string) (AWSSSMDocument, error) {
