...
// CrossAccountAttachment AWS CloudFormation Resource (AWS::GlobalAccelerator::CrossAccountAttachment)
...
func (r *CrossAccountAttachment) AWSCloudFormationType() string {
	return "AWS::GlobalAccelerator::CrossAccountAttachment"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CrossAccountAttachment) MarshalJSON() ([]byte, error) {
	type Properties CrossAccountAttachment
...
func (r *CrossAccountAttachment) UnmarshalJSON(b []byte) error {
	type Properties CrossAccountAttachment
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CrossAccountAttachment(*res.Properties)
	}
