...
type AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfiguration struct {
    ...
    CustomizedMetricSpecification AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification `json:"CustomizedMetricSpecification"`
    ...
    PredefinedMetricSpecification AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfigurationPredefinedMetricSpecification `json:"PredefinedMetricSpecification"`
...
func (r *AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfiguration) AWSCloudFormationType() string {
    return "AWS::ApplicationAutoScaling::ScalingPolicy.TargetTrackingScalingPolicyConfiguration"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSApplicationAutoScalingScalingPolicyTargetTrackingScalingPolicyConfiguration) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}