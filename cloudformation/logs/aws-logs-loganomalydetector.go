...
// LogAnomalyDetector AWS CloudFormation Resource (AWS::Logs::LogAnomalyDetector)
...
type LogAnomalyDetector struct {
	...
	// AnomalyVisibilityTime AWS CloudFormation Property
	// Required: false
	...
	// DetectorName AWS CloudFormation Property
	// Required: false
	...
	// EvaluationFrequency AWS CloudFormation Property
	// Required: false
	...
	// LogGroupArnList AWS CloudFormation Property
	// Required: false
...
func (r *LogAnomalyDetector) AWSCloudFormationType() string {
	return "AWS::Logs::LogAnomalyDetector"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LogAnomalyDetector) MarshalJSON() ([]byte, error) {
	type Properties LogAnomalyDetector
...
func (r *LogAnomalyDetector) UnmarshalJSON(b []byte) error {
	type Properties LogAnomalyDetector
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LogAnomalyDetector(*res.Properties)
	}
