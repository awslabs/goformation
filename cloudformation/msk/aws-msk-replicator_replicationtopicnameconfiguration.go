...
// Replicator_ReplicationTopicNameConfiguration AWS CloudFormation Resource (AWS::MSK::Replicator.ReplicationTopicNameConfiguration)
...
func (r *Replicator_ReplicationTopicNameConfiguration) AWSCloudFormationType() string {
	return "AWS::MSK::Replicator.ReplicationTopicNameConfiguration"
}
