...
func (t *CloudFormationTemplate) GetAllAWSEC2SecurityGroupResources () map[string]AWSEC2SecurityGroup {
...
func (t *CloudFormationTemplate) GetAWSEC2SecurityGroupWithName (name string) (AWSEC2SecurityGroup, error) {
