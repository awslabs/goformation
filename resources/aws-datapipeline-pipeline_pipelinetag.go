...
type AWSDataPipelinePipelinePipelineTag struct {
...
func (r *AWSDataPipelinePipelinePipelineTag) AWSCloudFormationType() string {
    return "AWS::DataPipeline::Pipeline.PipelineTag"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSDataPipelinePipelinePipelineTag) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}