...
// Analysis_InnerFilter AWS CloudFormation Resource (AWS::QuickSight::Analysis.InnerFilter)
...
func (r *Analysis_InnerFilter) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.InnerFilter"
}
