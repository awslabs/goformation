...
func (r *StateMachineVersion) AWSCloudFormationType() string {
	return "AWS::StepFunctions::StateMachineVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StateMachineVersion) MarshalJSON() ([]byte, error) {
	type Properties StateMachineVersion
...
func (r *StateMachineVersion) UnmarshalJSON(b []byte) error {
	type Properties StateMachineVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = StateMachineVersion(*res.Properties)
	}
