...
// Flow_InputConfiguration AWS CloudFormation Resource (AWS::MediaConnect::Flow.InputConfiguration)
...
type Flow_InputConfiguration struct {
	...
	// InputPort AWS CloudFormation Property
	// Required: true
	...
	Interface *Flow_Interface `json:"Interface"`
...
func (r *Flow_InputConfiguration) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Flow.InputConfiguration"
}
