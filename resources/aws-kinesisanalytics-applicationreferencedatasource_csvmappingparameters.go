...
type AWSKinesisAnalyticsApplicationReferenceDataSourceCSVMappingParameters struct {
...
func (r *AWSKinesisAnalyticsApplicationReferenceDataSourceCSVMappingParameters) AWSCloudFormationType() string {
    return "AWS::KinesisAnalytics::ApplicationReferenceDataSource.CSVMappingParameters"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSKinesisAnalyticsApplicationReferenceDataSourceCSVMappingParameters) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}