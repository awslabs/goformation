...
// Template_YAxisOptions AWS CloudFormation Resource (AWS::QuickSight::Template.YAxisOptions)
...
func (r *Template_YAxisOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.YAxisOptions"
}
