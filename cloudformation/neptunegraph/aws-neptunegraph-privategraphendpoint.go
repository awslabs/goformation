...
// PrivateGraphEndpoint AWS CloudFormation Resource (AWS::NeptuneGraph::PrivateGraphEndpoint)
...
func (r *PrivateGraphEndpoint) AWSCloudFormationType() string {
	return "AWS::NeptuneGraph::PrivateGraphEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PrivateGraphEndpoint) MarshalJSON() ([]byte, error) {
	type Properties PrivateGraphEndpoint
...
func (r *PrivateGraphEndpoint) UnmarshalJSON(b []byte) error {
	type Properties PrivateGraphEndpoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PrivateGraphEndpoint(*res.Properties)
	}
