...
func (t *CloudFormationTemplate) GetAllAWSEMRSecurityConfigurationResources() map[string]AWSEMRSecurityConfiguration {
...
func (t *CloudFormationTemplate) GetAWSEMRSecurityConfigurationWithName(name string) (AWSEMRSecurityConfiguration, error) {
