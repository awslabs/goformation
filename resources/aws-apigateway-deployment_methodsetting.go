...
type AWSApiGatewayDeploymentMethodSetting struct {
...
func (r *AWSApiGatewayDeploymentMethodSetting) AWSCloudFormationType() string {
	return "AWS::ApiGateway::Deployment.MethodSetting"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSApiGatewayDeploymentMethodSetting) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
