...
// TestCase_M2ManagedActionProperties AWS CloudFormation Resource (AWS::AppTest::TestCase.M2ManagedActionProperties)
...
type TestCase_M2ManagedActionProperties struct {
	...
	// ForceStop AWS CloudFormation Property
	// Required: false
	...
	// ImportDataSetLocation AWS CloudFormation Property
	// Required: false
	...
	ImportDataSetLocation *string `json:"ImportDataSetLocation,omitempty"`
...
func (r *TestCase_M2ManagedActionProperties) AWSCloudFormationType() string {
	return "AWS::AppTest::TestCase.M2ManagedActionProperties"
}
