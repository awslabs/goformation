...
// ProfileResourceAssociation AWS CloudFormation Resource (AWS::Route53Profiles::ProfileResourceAssociation)
...
type ProfileResourceAssociation struct {
	...
	// ResourceProperties AWS CloudFormation Property
	// Required: false
...
func (r *ProfileResourceAssociation) AWSCloudFormationType() string {
	return "AWS::Route53Profiles::ProfileResourceAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProfileResourceAssociation) MarshalJSON() ([]byte, error) {
	type Properties ProfileResourceAssociation
...
func (r *ProfileResourceAssociation) UnmarshalJSON(b []byte) error {
	type Properties ProfileResourceAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProfileResourceAssociation(*res.Properties)
	}
