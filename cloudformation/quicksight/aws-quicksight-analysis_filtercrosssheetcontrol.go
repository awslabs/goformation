...
// Analysis_FilterCrossSheetControl AWS CloudFormation Resource (AWS::QuickSight::Analysis.FilterCrossSheetControl)
...
func (r *Analysis_FilterCrossSheetControl) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.FilterCrossSheetControl"
}
