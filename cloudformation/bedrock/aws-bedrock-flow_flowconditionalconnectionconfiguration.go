...
// Flow_FlowConditionalConnectionConfiguration AWS CloudFormation Resource (AWS::Bedrock::Flow.FlowConditionalConnectionConfiguration)
...
func (r *Flow_FlowConditionalConnectionConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.FlowConditionalConnectionConfiguration"
}
