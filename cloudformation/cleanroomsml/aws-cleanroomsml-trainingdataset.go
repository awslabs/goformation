...
// TrainingDataset AWS CloudFormation Resource (AWS::CleanRoomsML::TrainingDataset)
...
type TrainingDataset struct {
	...
	// TrainingData AWS CloudFormation Property
	// Required: true
	...
	TrainingData []TrainingDataset_Dataset `json:"TrainingData"`
...
func (r *TrainingDataset) AWSCloudFormationType() string {
	return "AWS::CleanRoomsML::TrainingDataset"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrainingDataset) MarshalJSON() ([]byte, error) {
	type Properties TrainingDataset
...
func (r *TrainingDataset) UnmarshalJSON(b []byte) error {
	type Properties TrainingDataset
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TrainingDataset(*res.Properties)
	}
