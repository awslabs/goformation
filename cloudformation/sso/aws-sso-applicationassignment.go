...
// ApplicationAssignment AWS CloudFormation Resource (AWS::SSO::ApplicationAssignment)
...
func (r *ApplicationAssignment) AWSCloudFormationType() string {
	return "AWS::SSO::ApplicationAssignment"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ApplicationAssignment) MarshalJSON() ([]byte, error) {
	type Properties ApplicationAssignment
...
func (r *ApplicationAssignment) UnmarshalJSON(b []byte) error {
	type Properties ApplicationAssignment
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ApplicationAssignment(*res.Properties)
	}
