...
// AwsLogSource AWS CloudFormation Resource (AWS::SecurityLake::AwsLogSource)
...
func (r *AwsLogSource) AWSCloudFormationType() string {
	return "AWS::SecurityLake::AwsLogSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AwsLogSource) MarshalJSON() ([]byte, error) {
	type Properties AwsLogSource
...
func (r *AwsLogSource) UnmarshalJSON(b []byte) error {
	type Properties AwsLogSource
	res := &struct {
		Type                string
		Properties          *Properties
