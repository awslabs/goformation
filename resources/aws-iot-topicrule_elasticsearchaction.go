...
type AWSIoTTopicRuleElasticsearchAction struct {
...
func (r *AWSIoTTopicRuleElasticsearchAction) AWSCloudFormationType() string {
    return "AWS::IoT::TopicRule.ElasticsearchAction"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSIoTTopicRuleElasticsearchAction) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}