...
type AWSOpsWorksStackElasticIp struct {
...
func (r *AWSOpsWorksStackElasticIp) AWSCloudFormationType() string {
	return "AWS::OpsWorks::Stack.ElasticIp"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSOpsWorksStackElasticIp) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
