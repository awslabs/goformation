...
func (t *CloudFormationTemplate) GetAllAWSEC2RouteTableResources() map[string]AWSEC2RouteTable {
...
func (t *CloudFormationTemplate) GetAWSEC2RouteTableWithName(name string) (AWSEC2RouteTable, error) {
