...
func (r *AWSCloudFrontDistributionViewerCertificate) AWSCloudFormationType() string {
	return "AWS::CloudFront::Distribution.ViewerCertificate"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSCloudFrontDistributionViewerCertificate) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
