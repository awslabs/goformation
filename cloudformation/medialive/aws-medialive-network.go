...
type Network struct {
	...
	IpPools []Network_IpPool `json:"IpPools"`
	...
	// Routes AWS CloudFormation Property
	// Required: false
...
func (r *Network) AWSCloudFormationType() string {
