...
func (r *ConfiguredTableAssociation) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTableAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfiguredTableAssociation) MarshalJSON() ([]byte, error) {
	type Properties ConfiguredTableAssociation
...
func (r *ConfiguredTableAssociation) UnmarshalJSON(b []byte) error {
	type Properties ConfiguredTableAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ConfiguredTableAssociation(*res.Properties)
	}
