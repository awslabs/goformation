...
type AWSECSService struct {
    ...
    DeploymentConfiguration AWSECSServiceDeploymentConfiguration `json:"DeploymentConfiguration"`
    ...
    LoadBalancers []AWSECSServiceLoadBalancer `json:"LoadBalancers"`
    ...
    PlacementConstraints []AWSECSServicePlacementConstraint `json:"PlacementConstraints"`
    ...
    PlacementStrategies []AWSECSServicePlacementStrategy `json:"PlacementStrategies"`
