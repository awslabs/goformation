...
// JobDefinition_EksContainer AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.EksContainer)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-ekscontainer.html
...
func (r *JobDefinition_EksContainer) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.EksContainer"
}
