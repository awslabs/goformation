...
// DataSource_TransformationLambdaConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.TransformationLambdaConfiguration)
...
func (r *DataSource_TransformationLambdaConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.TransformationLambdaConfiguration"
}
