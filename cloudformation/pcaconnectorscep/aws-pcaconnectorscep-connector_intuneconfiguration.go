...
// Connector_IntuneConfiguration AWS CloudFormation Resource (AWS::PCAConnectorSCEP::Connector.IntuneConfiguration)
...
type Connector_IntuneConfiguration struct {
	...
	// AzureApplicationId AWS CloudFormation Property
	// Required: true
...
func (r *Connector_IntuneConfiguration) AWSCloudFormationType() string {
	return "AWS::PCAConnectorSCEP::Connector.IntuneConfiguration"
}
