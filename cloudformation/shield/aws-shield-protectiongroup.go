...
func (r *ProtectionGroup) AWSCloudFormationType() string {
	return "AWS::Shield::ProtectionGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProtectionGroup) MarshalJSON() ([]byte, error) {
	type Properties ProtectionGroup
...
func (r *ProtectionGroup) UnmarshalJSON(b []byte) error {
	type Properties ProtectionGroup
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProtectionGroup(*res.Properties)
	}
