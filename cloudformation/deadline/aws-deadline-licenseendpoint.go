...
func (r *LicenseEndpoint) AWSCloudFormationType() string {
	return "AWS::Deadline::LicenseEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LicenseEndpoint) MarshalJSON() ([]byte, error) {
	type Properties LicenseEndpoint
...
func (r *LicenseEndpoint) UnmarshalJSON(b []byte) error {
	type Properties LicenseEndpoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LicenseEndpoint(*res.Properties)
	}
