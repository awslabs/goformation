...
// AssetModel_PropertyPathDefinition AWS CloudFormation Resource (AWS::IoTSiteWise::AssetModel.PropertyPathDefinition)
...
func (r *AssetModel_PropertyPathDefinition) AWSCloudFormationType() string {
	return "AWS::IoTSiteWise::AssetModel.PropertyPathDefinition"
}
