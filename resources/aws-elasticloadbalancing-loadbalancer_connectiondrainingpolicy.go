...
type AWSElasticLoadBalancingLoadBalancerConnectionDrainingPolicy struct {
...
func (r *AWSElasticLoadBalancingLoadBalancerConnectionDrainingPolicy) AWSCloudFormationType() string {
    return "AWS::ElasticLoadBalancing::LoadBalancer.ConnectionDrainingPolicy"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSElasticLoadBalancingLoadBalancerConnectionDrainingPolicy) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}