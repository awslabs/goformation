...
// UserProfile_CodeRepository AWS CloudFormation Resource (AWS::SageMaker::UserProfile.CodeRepository)
...
func (r *UserProfile_CodeRepository) AWSCloudFormationType() string {
	return "AWS::SageMaker::UserProfile.CodeRepository"
}
