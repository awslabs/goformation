...
// Fleet_ServiceManagedEc2InstanceMarketOptions AWS CloudFormation Resource (AWS::Deadline::Fleet.ServiceManagedEc2InstanceMarketOptions)
...
func (r *Fleet_ServiceManagedEc2InstanceMarketOptions) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.ServiceManagedEc2InstanceMarketOptions"
}
