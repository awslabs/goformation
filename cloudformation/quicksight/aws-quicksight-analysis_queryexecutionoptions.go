...
// Analysis_QueryExecutionOptions AWS CloudFormation Resource (AWS::QuickSight::Analysis.QueryExecutionOptions)
...
func (r *Analysis_QueryExecutionOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.QueryExecutionOptions"
}
