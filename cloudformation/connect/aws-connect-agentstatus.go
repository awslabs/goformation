...
// AgentStatus AWS CloudFormation Resource (AWS::Connect::AgentStatus)
...
type AgentStatus struct {
	...
	// DisplayOrder AWS CloudFormation Property
	// Required: false
	...
	// ResetOrderNumber AWS CloudFormation Property
	// Required: false
...
func (r *AgentStatus) AWSCloudFormationType() string {
