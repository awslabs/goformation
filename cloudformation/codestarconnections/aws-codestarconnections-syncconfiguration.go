...
// SyncConfiguration AWS CloudFormation Resource (AWS::CodeStarConnections::SyncConfiguration)
...
type SyncConfiguration struct {
	...
	// PublishDeploymentStatus AWS CloudFormation Property
	// Required: false
	...
	// RepositoryLinkId AWS CloudFormation Property
	// Required: true
	...
	// TriggerResourceUpdateOn AWS CloudFormation Property
	// Required: false
...
func (r *SyncConfiguration) AWSCloudFormationType() string {
	return "AWS::CodeStarConnections::SyncConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SyncConfiguration) MarshalJSON() ([]byte, error) {
	type Properties SyncConfiguration
...
func (r *SyncConfiguration) UnmarshalJSON(b []byte) error {
	type Properties SyncConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SyncConfiguration(*res.Properties)
	}
