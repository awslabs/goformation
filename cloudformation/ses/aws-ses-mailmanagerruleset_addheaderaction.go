...
// MailManagerRuleSet_AddHeaderAction AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.AddHeaderAction)
...
func (r *MailManagerRuleSet_AddHeaderAction) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.AddHeaderAction"
}
