...
// ModelPackage_SecurityConfig AWS CloudFormation Resource (AWS::SageMaker::ModelPackage.SecurityConfig)
...
func (r *ModelPackage_SecurityConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::ModelPackage.SecurityConfig"
}
