...
func (t *CloudFormationTemplate) GetAllAWSEC2NetworkAclResources() map[string]AWSEC2NetworkAcl {
...
func (t *CloudFormationTemplate) GetAWSEC2NetworkAclWithName(name string) (AWSEC2NetworkAcl, error) {
