...
// CertificateProvider AWS CloudFormation Resource (AWS::IoT::CertificateProvider)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-certificateprovider.html
type CertificateProvider struct {

	// AccountDefaultForOperations AWS CloudFormation Property
	// Required: true
...
func (r *CertificateProvider) AWSCloudFormationType() string {
	return "AWS::IoT::CertificateProvider"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CertificateProvider) MarshalJSON() ([]byte, error) {
	type Properties CertificateProvider
...
func (r *CertificateProvider) UnmarshalJSON(b []byte) error {
	type Properties CertificateProvider
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CertificateProvider(*res.Properties)
	}
