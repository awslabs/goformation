...
// MailManagerArchive AWS CloudFormation Resource (AWS::SES::MailManagerArchive)
...
func (r *MailManagerArchive) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerArchive"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerArchive) MarshalJSON() ([]byte, error) {
	type Properties MailManagerArchive
...
func (r *MailManagerArchive) UnmarshalJSON(b []byte) error {
	type Properties MailManagerArchive
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerArchive(*res.Properties)
	}
