...
func (t *CloudFormationTemplate) GetAllAWSApiGatewayAuthorizerResources() map[string]AWSApiGatewayAuthorizer {
...
func (t *CloudFormationTemplate) GetAWSApiGatewayAuthorizerWithName(name string) (AWSApiGatewayAuthorizer, error) {
