...
// Application_SignInOptions AWS CloudFormation Resource (AWS::SSO::Application.SignInOptions)
...
type Application_SignInOptions struct {
	...
	// ApplicationUrl AWS CloudFormation Property
	// Required: false
...
func (r *Application_SignInOptions) AWSCloudFormationType() string {
	return "AWS::SSO::Application.SignInOptions"
}
