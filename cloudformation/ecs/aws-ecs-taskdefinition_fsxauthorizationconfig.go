...
// TaskDefinition_FSxAuthorizationConfig AWS CloudFormation Resource (AWS::ECS::TaskDefinition.FSxAuthorizationConfig)
...
func (r *TaskDefinition_FSxAuthorizationConfig) AWSCloudFormationType() string {
	return "AWS::ECS::TaskDefinition.FSxAuthorizationConfig"
}
