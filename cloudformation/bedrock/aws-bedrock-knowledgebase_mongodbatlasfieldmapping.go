...
// KnowledgeBase_MongoDbAtlasFieldMapping AWS CloudFormation Resource (AWS::Bedrock::KnowledgeBase.MongoDbAtlasFieldMapping)
...
func (r *KnowledgeBase_MongoDbAtlasFieldMapping) AWSCloudFormationType() string {
	return "AWS::Bedrock::KnowledgeBase.MongoDbAtlasFieldMapping"
}
