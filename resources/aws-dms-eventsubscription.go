...
func GetAllAWSDMSEventSubscriptionResources(template *Template) map[string]*AWSDMSEventSubscription {
...
func GetAWSDMSEventSubscriptionWithName(name string, template *Template) (*AWSDMSEventSubscription, error) {
