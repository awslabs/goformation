...
func (r *SoftwarePackage) AWSCloudFormationType() string {
	return "AWS::IoT::SoftwarePackage"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SoftwarePackage) MarshalJSON() ([]byte, error) {
	type Properties SoftwarePackage
...
func (r *SoftwarePackage) UnmarshalJSON(b []byte) error {
	type Properties SoftwarePackage
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SoftwarePackage(*res.Properties)
	}
