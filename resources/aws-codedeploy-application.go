...
func GetAllAWSCodeDeployApplication(template *Template) map[string]*AWSCodeDeployApplication {
...
func GetWithNameAWSCodeDeployApplication(name string, template *Template) (*AWSCodeDeployApplication, error) {
