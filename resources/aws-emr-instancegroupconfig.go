...
type AWSEMRInstanceGroupConfig struct {
	...
	AutoScalingPolicy AWSEMRInstanceGroupConfigAutoScalingPolicy `json:"AutoScalingPolicy"`
	...
	Configurations []AWSEMRInstanceGroupConfigConfiguration `json:"Configurations"`
	...
	EbsConfiguration AWSEMRInstanceGroupConfigEbsConfiguration `json:"EbsConfiguration"`
