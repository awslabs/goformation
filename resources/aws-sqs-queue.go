...
func (t *CloudFormationTemplate) GetAllAWSSQSQueueResources () map[string]AWSSQSQueue {
...
func (t *CloudFormationTemplate) GetAWSSQSQueueWithName (name string) (AWSSQSQueue, error) {
