...
func (r *DirectoryRegistration) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::DirectoryRegistration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DirectoryRegistration) MarshalJSON() ([]byte, error) {
	type Properties DirectoryRegistration
...
func (r *DirectoryRegistration) UnmarshalJSON(b []byte) error {
	type Properties DirectoryRegistration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DirectoryRegistration(*res.Properties)
	}
