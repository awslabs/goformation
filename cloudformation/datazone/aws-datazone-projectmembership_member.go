...
// ProjectMembership_Member AWS CloudFormation Resource (AWS::DataZone::ProjectMembership.Member)
...
func (r *ProjectMembership_Member) AWSCloudFormationType() string {
	return "AWS::DataZone::ProjectMembership.Member"
}
