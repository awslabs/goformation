...
// FindingAggregator AWS CloudFormation Resource (AWS::SecurityHub::FindingAggregator)
...
func (r *FindingAggregator) AWSCloudFormationType() string {
	return "AWS::SecurityHub::FindingAggregator"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FindingAggregator) MarshalJSON() ([]byte, error) {
	type Properties FindingAggregator
...
func (r *FindingAggregator) UnmarshalJSON(b []byte) error {
	type Properties FindingAggregator
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = FindingAggregator(*res.Properties)
	}
