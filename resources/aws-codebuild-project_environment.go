...
type AWSCodeBuildProjectEnvironment struct {
	...
	EnvironmentVariables []AWSCodeBuildProjectEnvironmentEnvironmentVariable `json:"EnvironmentVariables"`
...
func (r *AWSCodeBuildProjectEnvironment) AWSCloudFormationType() string {
	return "AWS::CodeBuild::Project.Environment"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSCodeBuildProjectEnvironment) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
