...
type VodSource struct {
	...
	HttpPackageConfigurations []VodSource_HttpPackageConfiguration `json:"HttpPackageConfigurations"`
...
func (r *VodSource) AWSCloudFormationType() string {
	return "AWS::MediaTailor::VodSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VodSource) MarshalJSON() ([]byte, error) {
	type Properties VodSource
...
func (r *VodSource) UnmarshalJSON(b []byte) error {
	type Properties VodSource
	res := &struct {
		Type                string
		Properties          *Properties
