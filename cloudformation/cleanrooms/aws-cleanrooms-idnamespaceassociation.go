...
// IdNamespaceAssociation AWS CloudFormation Resource (AWS::CleanRooms::IdNamespaceAssociation)
...
type IdNamespaceAssociation struct {
	...
	// IdMappingConfig AWS CloudFormation Property
	// Required: false
	...
	// InputReferenceConfig AWS CloudFormation Property
	// Required: true
	...
	InputReferenceConfig *IdNamespaceAssociation_IdNamespaceAssociationInputReferenceConfig `json:"InputReferenceConfig"`
...
func (r *IdNamespaceAssociation) AWSCloudFormationType() string {
	return "AWS::CleanRooms::IdNamespaceAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdNamespaceAssociation) MarshalJSON() ([]byte, error) {
	type Properties IdNamespaceAssociation
...
func (r *IdNamespaceAssociation) UnmarshalJSON(b []byte) error {
	type Properties IdNamespaceAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IdNamespaceAssociation(*res.Properties)
	}
