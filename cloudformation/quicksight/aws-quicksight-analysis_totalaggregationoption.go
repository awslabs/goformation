...
type Analysis_TotalAggregationOption struct {
	...
	TotalAggregationFunction *Analysis_TotalAggregationFunction `json:"TotalAggregationFunction"`
...
func (r *Analysis_TotalAggregationOption) AWSCloudFormationType() string {
