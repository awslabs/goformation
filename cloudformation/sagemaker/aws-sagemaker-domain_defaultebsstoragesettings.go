...
// Domain_DefaultEbsStorageSettings AWS CloudFormation Resource (AWS::SageMaker::Domain.DefaultEbsStorageSettings)
...
func (r *Domain_DefaultEbsStorageSettings) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.DefaultEbsStorageSettings"
}
