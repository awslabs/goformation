...
func GetAllAWSCloudTrailTrail(template *Template) map[string]*AWSCloudTrailTrail {
...
func GetWithNameAWSCloudTrailTrail(name string, template *Template) (*AWSCloudTrailTrail, error) {
