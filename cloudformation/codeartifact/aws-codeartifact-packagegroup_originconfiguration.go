...
// PackageGroup_OriginConfiguration AWS CloudFormation Resource (AWS::CodeArtifact::PackageGroup.OriginConfiguration)
...
type PackageGroup_OriginConfiguration struct {
	...
	Restrictions *PackageGroup_Restrictions `json:"Restrictions"`
...
func (r *PackageGroup_OriginConfiguration) AWSCloudFormationType() string {
	return "AWS::CodeArtifact::PackageGroup.OriginConfiguration"
}
