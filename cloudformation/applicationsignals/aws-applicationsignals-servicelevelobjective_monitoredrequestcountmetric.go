...
// ServiceLevelObjective_MonitoredRequestCountMetric AWS CloudFormation Resource (AWS::ApplicationSignals::ServiceLevelObjective.MonitoredRequestCountMetric)
...
type ServiceLevelObjective_MonitoredRequestCountMetric struct {
	...
	// BadCountMetric AWS CloudFormation Property
	// Required: false
	...
	// GoodCountMetric AWS CloudFormation Property
	// Required: false
...
func (r *ServiceLevelObjective_MonitoredRequestCountMetric) AWSCloudFormationType() string {
	return "AWS::ApplicationSignals::ServiceLevelObjective.MonitoredRequestCountMetric"
}
