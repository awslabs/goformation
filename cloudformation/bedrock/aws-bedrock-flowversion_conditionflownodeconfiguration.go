...
// FlowVersion_ConditionFlowNodeConfiguration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.ConditionFlowNodeConfiguration)
...
type FlowVersion_ConditionFlowNodeConfiguration struct {
	...
	Conditions []FlowVersion_FlowCondition `json:"Conditions"`
...
func (r *FlowVersion_ConditionFlowNodeConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.ConditionFlowNodeConfiguration"
}
