...
// EnvironmentActions AWS CloudFormation Resource (AWS::DataZone::EnvironmentActions)
...
func (r *EnvironmentActions) AWSCloudFormationType() string {
	return "AWS::DataZone::EnvironmentActions"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EnvironmentActions) MarshalJSON() ([]byte, error) {
	type Properties EnvironmentActions
...
func (r *EnvironmentActions) UnmarshalJSON(b []byte) error {
	type Properties EnvironmentActions
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EnvironmentActions(*res.Properties)
	}
