...
// TLSInspectionConfiguration_PortRange AWS CloudFormation Resource (AWS::NetworkFirewall::TLSInspectionConfiguration.PortRange)
...
func (r *TLSInspectionConfiguration_PortRange) AWSCloudFormationType() string {
	return "AWS::NetworkFirewall::TLSInspectionConfiguration.PortRange"
}
