...
type AWSElasticBeanstalkConfigurationTemplate struct {
    ...
    OptionSettings []AWSElasticBeanstalkConfigurationTemplateConfigurationOptionSetting `json:"OptionSettings"`
    ...
    SourceConfiguration AWSElasticBeanstalkConfigurationTemplateSourceConfiguration `json:"SourceConfiguration"`
