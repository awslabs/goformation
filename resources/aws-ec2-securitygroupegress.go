...
func (t *CloudFormationTemplate) GetAllAWSEC2SecurityGroupEgressResources () map[string]AWSEC2SecurityGroupEgress {
...
func (t *CloudFormationTemplate) GetAWSEC2SecurityGroupEgressWithName (name string) (AWSEC2SecurityGroupEgress, error) {
