...
// PredefinedAttribute_Values AWS CloudFormation Resource (AWS::Connect::PredefinedAttribute.Values)
...
func (r *PredefinedAttribute_Values) AWSCloudFormationType() string {
	return "AWS::Connect::PredefinedAttribute.Values"
}
