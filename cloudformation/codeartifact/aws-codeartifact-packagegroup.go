...
type PackageGroup struct {
	...
	// OriginConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *PackageGroup) AWSCloudFormationType() string {
	return "AWS::CodeArtifact::PackageGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PackageGroup) MarshalJSON() ([]byte, error) {
	type Properties PackageGroup
...
func (r *PackageGroup) UnmarshalJSON(b []byte) error {
	type Properties PackageGroup
	res := &struct {
		Type                string
		Properties          *Properties
