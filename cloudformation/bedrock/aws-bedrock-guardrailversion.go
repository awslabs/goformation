...
// GuardrailVersion AWS CloudFormation Resource (AWS::Bedrock::GuardrailVersion)
...
func (r *GuardrailVersion) AWSCloudFormationType() string {
	return "AWS::Bedrock::GuardrailVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r GuardrailVersion) MarshalJSON() ([]byte, error) {
	type Properties GuardrailVersion
...
func (r *GuardrailVersion) UnmarshalJSON(b []byte) error {
	type Properties GuardrailVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = GuardrailVersion(*res.Properties)
	}
