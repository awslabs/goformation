...
func (t *CloudFormationTemplate) GetAllAWSIAMUserResources () map[string]AWSIAMUser {
...
func (t *CloudFormationTemplate) GetAWSIAMUserWithName (name string) (AWSIAMUser, error) {
