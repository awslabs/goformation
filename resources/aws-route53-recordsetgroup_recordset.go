...
type AWSRoute53RecordSetGroupRecordSet struct {
	...
	AliasTarget AWSRoute53RecordSetGroupRecordSetAliasTarget `json:"AliasTarget"`
	...
	GeoLocation AWSRoute53RecordSetGroupRecordSetGeoLocation `json:"GeoLocation"`
...
func (r *AWSRoute53RecordSetGroupRecordSet) AWSCloudFormationType() string {
	return "AWS::Route53::RecordSetGroup.RecordSet"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSRoute53RecordSetGroupRecordSet) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
