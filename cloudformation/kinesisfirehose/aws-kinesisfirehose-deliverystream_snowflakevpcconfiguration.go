...
// DeliveryStream_SnowflakeVpcConfiguration AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.SnowflakeVpcConfiguration)
...
type DeliveryStream_SnowflakeVpcConfiguration struct {
	...
	// PrivateLinkVpceId AWS CloudFormation Property
	// Required: true
...
func (r *DeliveryStream_SnowflakeVpcConfiguration) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.SnowflakeVpcConfiguration"
}
