...
// Agent_FunctionSchema AWS CloudFormation Resource (AWS::Bedrock::Agent.FunctionSchema)
...
type Agent_FunctionSchema struct {
	...
	Functions []Agent_Function `json:"Functions"`
...
func (r *Agent_FunctionSchema) AWSCloudFormationType() string {
	return "AWS::Bedrock::Agent.FunctionSchema"
}
