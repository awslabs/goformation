...
type Transformer struct {
	...
	EdiType *Transformer_EdiType `json:"EdiType"`
	...
	// MappingTemplate AWS CloudFormation Property
	// Required: true
	...
	// SampleDocument AWS CloudFormation Property
	// Required: false
