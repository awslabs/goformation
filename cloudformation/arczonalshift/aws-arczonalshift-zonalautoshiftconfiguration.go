...
// ZonalAutoshiftConfiguration AWS CloudFormation Resource (AWS::ARCZonalShift::ZonalAutoshiftConfiguration)
...
type ZonalAutoshiftConfiguration struct {
	...
	// PracticeRunConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *ZonalAutoshiftConfiguration) AWSCloudFormationType() string {
	return "AWS::ARCZonalShift::ZonalAutoshiftConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ZonalAutoshiftConfiguration) MarshalJSON() ([]byte, error) {
	type Properties ZonalAutoshiftConfiguration
...
func (r *ZonalAutoshiftConfiguration) UnmarshalJSON(b []byte) error {
	type Properties ZonalAutoshiftConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ZonalAutoshiftConfiguration(*res.Properties)
	}
