...
func (t *CloudFormationTemplate) GetAllAWSCodePipelinePipelineResources() map[string]AWSCodePipelinePipeline {
...
func (t *CloudFormationTemplate) GetAWSCodePipelinePipelineWithName(name string) (AWSCodePipelinePipeline, error) {
