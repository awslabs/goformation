...
// MailManagerRuleSet AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet)
...
type MailManagerRuleSet struct {
	...
	Rules []MailManagerRuleSet_Rule `json:"Rules"`
...
func (r *MailManagerRuleSet) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerRuleSet) MarshalJSON() ([]byte, error) {
	type Properties MailManagerRuleSet
...
func (r *MailManagerRuleSet) UnmarshalJSON(b []byte) error {
	type Properties MailManagerRuleSet
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerRuleSet(*res.Properties)
	}
