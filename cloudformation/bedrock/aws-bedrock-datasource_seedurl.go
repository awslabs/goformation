...
// DataSource_SeedUrl AWS CloudFormation Resource (AWS::Bedrock::DataSource.SeedUrl)
...
func (r *DataSource_SeedUrl) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.SeedUrl"
}
