...
type Template_CertificateValidity struct {
	...
	RenewalPeriod *Template_ValidityPeriod `json:"RenewalPeriod"`
	...
	ValidityPeriod *Template_ValidityPeriod `json:"ValidityPeriod"`
...
func (r *Template_CertificateValidity) AWSCloudFormationType() string {
