...
// SdiSource AWS CloudFormation Resource (AWS::MediaLive::SdiSource)
...
func (r *SdiSource) AWSCloudFormationType() string {
	return "AWS::MediaLive::SdiSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SdiSource) MarshalJSON() ([]byte, error) {
	type Properties SdiSource
...
func (r *SdiSource) UnmarshalJSON(b []byte) error {
	type Properties SdiSource
	res := &struct {
		Type                string
		Properties          *Properties
