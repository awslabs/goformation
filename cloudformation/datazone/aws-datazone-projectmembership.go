...
// ProjectMembership AWS CloudFormation Resource (AWS::DataZone::ProjectMembership)
...
type ProjectMembership struct {
	...
	Member *ProjectMembership_Member `json:"Member"`
...
func (r *ProjectMembership) AWSCloudFormationType() string {
	return "AWS::DataZone::ProjectMembership"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProjectMembership) MarshalJSON() ([]byte, error) {
	type Properties ProjectMembership
...
func (r *ProjectMembership) UnmarshalJSON(b []byte) error {
	type Properties ProjectMembership
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProjectMembership(*res.Properties)
	}
