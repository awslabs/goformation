...
func (r *NetworkSettings) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::NetworkSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NetworkSettings) MarshalJSON() ([]byte, error) {
	type Properties NetworkSettings
...
func (r *NetworkSettings) UnmarshalJSON(b []byte) error {
	type Properties NetworkSettings
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = NetworkSettings(*res.Properties)
	}
