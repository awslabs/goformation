...
type AWSCodePipelinePipeline struct {
	...
	ArtifactStore AWSCodePipelinePipelineArtifactStore `json:"ArtifactStore"`
	...
	DisableInboundStageTransitions []AWSCodePipelinePipelineStageTransition `json:"DisableInboundStageTransitions"`
	...
	Stages []AWSCodePipelinePipelineStageDeclaration `json:"Stages"`
}
