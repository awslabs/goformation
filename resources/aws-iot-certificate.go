...
func (t *CloudFormationTemplate) GetAllAWSIoTCertificateResources() map[string]AWSIoTCertificate {
...
func (t *CloudFormationTemplate) GetAWSIoTCertificateWithName(name string) (AWSIoTCertificate, error) {
