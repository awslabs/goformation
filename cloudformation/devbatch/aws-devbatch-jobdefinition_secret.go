...
// JobDefinition_Secret AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.Secret)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-secret.html
...
func (r *JobDefinition_Secret) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.Secret"
}
