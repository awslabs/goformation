...
// JobDefinition_MountPoints AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.MountPoints)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-mountpoints.html
...
func (r *JobDefinition_MountPoints) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.MountPoints"
}
