...
// TestCase_TestCaseLatestVersion AWS CloudFormation Resource (AWS::AppTest::TestCase.TestCaseLatestVersion)
...
func (r *TestCase_TestCaseLatestVersion) AWSCloudFormationType() string {
	return "AWS::AppTest::TestCase.TestCaseLatestVersion"
}
