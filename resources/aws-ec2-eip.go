...
func (t *CloudFormationTemplate) GetAllAWSEC2EIPResources () map[string]AWSEC2EIP {
...
func (t *CloudFormationTemplate) GetAWSEC2EIPWithName (name string) (AWSEC2EIP, error) {
