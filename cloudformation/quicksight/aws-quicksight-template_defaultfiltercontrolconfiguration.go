...
// Template_DefaultFilterControlConfiguration AWS CloudFormation Resource (AWS::QuickSight::Template.DefaultFilterControlConfiguration)
...
type Template_DefaultFilterControlConfiguration struct {
	...
	ControlOptions *Template_DefaultFilterControlOptions `json:"ControlOptions"`
...
func (r *Template_DefaultFilterControlConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.DefaultFilterControlConfiguration"
}
