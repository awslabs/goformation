...
// Flow_Interface AWS CloudFormation Resource (AWS::MediaConnect::Flow.Interface)
...
func (r *Flow_Interface) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Flow.Interface"
}
