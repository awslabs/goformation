...
func (t *CloudFormationTemplate) GetAllAWSKinesisAnalyticsApplicationOutputResources () map[string]AWSKinesisAnalyticsApplicationOutput {
...
func (t *CloudFormationTemplate) GetAWSKinesisAnalyticsApplicationOutputWithName (name string) (AWSKinesisAnalyticsApplicationOutput, error) {
