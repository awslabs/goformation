...
// Dashboard_YAxisOptions AWS CloudFormation Resource (AWS::QuickSight::Dashboard.YAxisOptions)
...
func (r *Dashboard_YAxisOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.YAxisOptions"
}
