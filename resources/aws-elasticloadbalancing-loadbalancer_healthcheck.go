...
type AWSElasticLoadBalancingLoadBalancerHealthCheck struct {
...
func (r *AWSElasticLoadBalancingLoadBalancerHealthCheck) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancing::LoadBalancer.HealthCheck"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSElasticLoadBalancingLoadBalancerHealthCheck) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
