...
// Policy_IcmpTypeCode AWS CloudFormation Resource (AWS::FMS::Policy.IcmpTypeCode)
...
func (r *Policy_IcmpTypeCode) AWSCloudFormationType() string {
	return "AWS::FMS::Policy.IcmpTypeCode"
}
