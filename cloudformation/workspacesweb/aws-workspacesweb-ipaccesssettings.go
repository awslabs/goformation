...
type IpAccessSettings struct {
	...
	IpRules []IpAccessSettings_IpRule `json:"IpRules"`
...
func (r *IpAccessSettings) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::IpAccessSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IpAccessSettings) MarshalJSON() ([]byte, error) {
	type Properties IpAccessSettings
...
func (r *IpAccessSettings) UnmarshalJSON(b []byte) error {
	type Properties IpAccessSettings
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IpAccessSettings(*res.Properties)
	}
