...
func (t *CloudFormationTemplate) GetAllAWSWAFByteMatchSetResources () map[string]AWSWAFByteMatchSet {
...
func (t *CloudFormationTemplate) GetAWSWAFByteMatchSetWithName (name string) (AWSWAFByteMatchSet, error) {
