...
type AWSWAFRulePredicate struct {
...
func (r *AWSWAFRulePredicate) AWSCloudFormationType() string {
	return "AWS::WAF::Rule.Predicate"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSWAFRulePredicate) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
