...
// WorkerConfiguration AWS CloudFormation Resource (AWS::KafkaConnect::WorkerConfiguration)
...
type WorkerConfiguration struct {
	...
	// PropertiesFileContent AWS CloudFormation Property
	// Required: true
...
func (r *WorkerConfiguration) AWSCloudFormationType() string {
	return "AWS::KafkaConnect::WorkerConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkerConfiguration) MarshalJSON() ([]byte, error) {
	type Properties WorkerConfiguration
...
func (r *WorkerConfiguration) UnmarshalJSON(b []byte) error {
	type Properties WorkerConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkerConfiguration(*res.Properties)
	}
