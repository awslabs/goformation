...
// UsageProfile AWS CloudFormation Resource (AWS::Glue::UsageProfile)
...
func (r *UsageProfile) AWSCloudFormationType() string {
	return "AWS::Glue::UsageProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r UsageProfile) MarshalJSON() ([]byte, error) {
	type Properties UsageProfile
...
func (r *UsageProfile) UnmarshalJSON(b []byte) error {
	type Properties UsageProfile
	res := &struct {
		Type                string
		Properties          *Properties
