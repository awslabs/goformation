...
type AWSEC2NetworkInterface struct {
	...
	Ipv6Addresses AWSEC2NetworkInterfaceInstanceIpv6Address `json:"Ipv6Addresses"`
	...
	PrivateIpAddresses []AWSEC2NetworkInterfacePrivateIpAddressSpecification `json:"PrivateIpAddresses"`
	...
	Tags []AWSEC2NetworkInterfaceTag `json:"Tags"`
}
