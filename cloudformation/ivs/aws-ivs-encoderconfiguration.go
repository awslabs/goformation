...
// EncoderConfiguration AWS CloudFormation Resource (AWS::IVS::EncoderConfiguration)
...
func (r *EncoderConfiguration) AWSCloudFormationType() string {
	return "AWS::IVS::EncoderConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EncoderConfiguration) MarshalJSON() ([]byte, error) {
	type Properties EncoderConfiguration
...
func (r *EncoderConfiguration) UnmarshalJSON(b []byte) error {
	type Properties EncoderConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EncoderConfiguration(*res.Properties)
	}
