...
// DelegatedAdmin AWS CloudFormation Resource (AWS::SecurityHub::DelegatedAdmin)
...
type DelegatedAdmin struct {
	...
	// AdminAccountId AWS CloudFormation Property
	// Required: true
...
func (r *DelegatedAdmin) AWSCloudFormationType() string {
	return "AWS::SecurityHub::DelegatedAdmin"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DelegatedAdmin) MarshalJSON() ([]byte, error) {
	type Properties DelegatedAdmin
...
func (r *DelegatedAdmin) UnmarshalJSON(b []byte) error {
	type Properties DelegatedAdmin
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DelegatedAdmin(*res.Properties)
	}
