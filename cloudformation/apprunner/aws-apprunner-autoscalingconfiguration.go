...
func (r *AutoScalingConfiguration) AWSCloudFormationType() string {
	return "AWS::AppRunner::AutoScalingConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AutoScalingConfiguration) MarshalJSON() ([]byte, error) {
	type Properties AutoScalingConfiguration
...
func (r *AutoScalingConfiguration) UnmarshalJSON(b []byte) error {
	type Properties AutoScalingConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AutoScalingConfiguration(*res.Properties)
	}
