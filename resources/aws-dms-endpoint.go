...
func (t *CloudFormationTemplate) GetAllAWSDMSEndpointResources() map[string]AWSDMSEndpoint {
...
func (t *CloudFormationTemplate) GetAWSDMSEndpointWithName(name string) (AWSDMSEndpoint, error) {
