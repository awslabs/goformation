...
// Flow_PromptInputVariable AWS CloudFormation Resource (AWS::Bedrock::Flow.PromptInputVariable)
...
func (r *Flow_PromptInputVariable) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.PromptInputVariable"
}
