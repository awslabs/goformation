...
// Membership_MembershipQueryComputePaymentConfig AWS CloudFormation Resource (AWS::CleanRooms::Membership.MembershipQueryComputePaymentConfig)
...
func (r *Membership_MembershipQueryComputePaymentConfig) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership.MembershipQueryComputePaymentConfig"
}
