...
// Flow_FlowNodeOutput AWS CloudFormation Resource (AWS::Bedrock::Flow.FlowNodeOutput)
...
func (r *Flow_FlowNodeOutput) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.FlowNodeOutput"
}
