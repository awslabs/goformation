...
// Cluster_ManagedStorageConfiguration AWS CloudFormation Resource (AWS::ECS::Cluster.ManagedStorageConfiguration)
...
type Cluster_ManagedStorageConfiguration struct {
	...
	// FargateEphemeralStorageKmsKeyId AWS CloudFormation Property
	// Required: false
...
func (r *Cluster_ManagedStorageConfiguration) AWSCloudFormationType() string {
