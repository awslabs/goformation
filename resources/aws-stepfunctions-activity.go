...
func (t *CloudFormationTemplate) GetAllAWSStepFunctionsActivityResources () map[string]AWSStepFunctionsActivity {
...
func (t *CloudFormationTemplate) GetAWSStepFunctionsActivityWithName (name string) (AWSStepFunctionsActivity, error) {
