...
// Integration_ResponseParameterMap AWS CloudFormation Resource (AWS::ApiGatewayV2::Integration.ResponseParameterMap)
...
func (r *Integration_ResponseParameterMap) AWSCloudFormationType() string {
	return "AWS::ApiGatewayV2::Integration.ResponseParameterMap"
}
