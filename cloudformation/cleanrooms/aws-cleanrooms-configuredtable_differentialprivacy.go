...
// ConfiguredTable_DifferentialPrivacy AWS CloudFormation Resource (AWS::CleanRooms::ConfiguredTable.DifferentialPrivacy)
...
type ConfiguredTable_DifferentialPrivacy struct {
	...
	Columns []ConfiguredTable_DifferentialPrivacyColumn `json:"Columns"`
...
func (r *ConfiguredTable_DifferentialPrivacy) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTable.DifferentialPrivacy"
}
