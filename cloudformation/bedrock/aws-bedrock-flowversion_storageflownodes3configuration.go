...
// FlowVersion_StorageFlowNodeS3Configuration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.StorageFlowNodeS3Configuration)
...
func (r *FlowVersion_StorageFlowNodeS3Configuration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.StorageFlowNodeS3Configuration"
}
