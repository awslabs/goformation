...
// EnabledBaseline AWS CloudFormation Resource (AWS::ControlTower::EnabledBaseline)
...
type EnabledBaseline struct {
	...
	// BaselineIdentifier AWS CloudFormation Property
	// Required: true
	...
	BaselineIdentifier string `json:"BaselineIdentifier"`

	// BaselineVersion AWS CloudFormation Property
	// Required: true
...
func (r *EnabledBaseline) AWSCloudFormationType() string {
	return "AWS::ControlTower::EnabledBaseline"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EnabledBaseline) MarshalJSON() ([]byte, error) {
	type Properties EnabledBaseline
...
func (r *EnabledBaseline) UnmarshalJSON(b []byte) error {
	type Properties EnabledBaseline
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EnabledBaseline(*res.Properties)
	}
