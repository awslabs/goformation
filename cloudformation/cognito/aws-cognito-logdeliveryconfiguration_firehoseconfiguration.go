...
// LogDeliveryConfiguration_FirehoseConfiguration AWS CloudFormation Resource (AWS::Cognito::LogDeliveryConfiguration.FirehoseConfiguration)
...
func (r *LogDeliveryConfiguration_FirehoseConfiguration) AWSCloudFormationType() string {
	return "AWS::Cognito::LogDeliveryConfiguration.FirehoseConfiguration"
}
