...
// MailManagerRelay_RelayAuthentication AWS CloudFormation Resource (AWS::SES::MailManagerRelay.RelayAuthentication)
...
type MailManagerRelay_RelayAuthentication struct {
	...
	NoAuthentication interface{} `json:"NoAuthentication,omitempty"`
...
func (r *MailManagerRelay_RelayAuthentication) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRelay.RelayAuthentication"
}
