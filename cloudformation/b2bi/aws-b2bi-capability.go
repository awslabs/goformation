...
// Capability AWS CloudFormation Resource (AWS::B2BI::Capability)
...
type Capability struct {
	...
	Configuration *Capability_CapabilityConfiguration `json:"Configuration"`

	// InstructionsDocuments AWS CloudFormation Property
	// Required: false
