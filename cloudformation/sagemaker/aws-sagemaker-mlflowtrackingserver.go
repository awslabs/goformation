...
// MlflowTrackingServer AWS CloudFormation Resource (AWS::SageMaker::MlflowTrackingServer)
...
type MlflowTrackingServer struct {
	...
	// AutomaticModelRegistration AWS CloudFormation Property
	// Required: false
	...
	// MlflowVersion AWS CloudFormation Property
	// Required: false
	...
	// TrackingServerName AWS CloudFormation Property
	// Required: true
	...
	// TrackingServerSize AWS CloudFormation Property
	// Required: false
...
func (r *MlflowTrackingServer) AWSCloudFormationType() string {
	return "AWS::SageMaker::MlflowTrackingServer"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MlflowTrackingServer) MarshalJSON() ([]byte, error) {
	type Properties MlflowTrackingServer
...
func (r *MlflowTrackingServer) UnmarshalJSON(b []byte) error {
	type Properties MlflowTrackingServer
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MlflowTrackingServer(*res.Properties)
	}
