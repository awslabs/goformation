...
// Image_WorkflowParameter AWS CloudFormation Resource (AWS::ImageBuilder::Image.WorkflowParameter)
...
func (r *Image_WorkflowParameter) AWSCloudFormationType() string {
	return "AWS::ImageBuilder::Image.WorkflowParameter"
}
