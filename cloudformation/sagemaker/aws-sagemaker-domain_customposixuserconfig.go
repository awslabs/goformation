...
// Domain_CustomPosixUserConfig AWS CloudFormation Resource (AWS::SageMaker::Domain.CustomPosixUserConfig)
...
func (r *Domain_CustomPosixUserConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.CustomPosixUserConfig"
}
