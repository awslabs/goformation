...
// DataSource_SharePointDataSourceConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.SharePointDataSourceConfiguration)
...
type DataSource_SharePointDataSourceConfiguration struct {
	...
	SourceConfiguration *DataSource_SharePointSourceConfiguration `json:"SourceConfiguration"`
...
func (r *DataSource_SharePointDataSourceConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.SharePointDataSourceConfiguration"
}
