...
func (t *CloudFormationTemplate) GetAllAWSIoTPolicyPrincipalAttachmentResources () map[string]AWSIoTPolicyPrincipalAttachment {
...
func (t *CloudFormationTemplate) GetAWSIoTPolicyPrincipalAttachmentWithName (name string) (AWSIoTPolicyPrincipalAttachment, error) {
