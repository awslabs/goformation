...
// ImagePipeline_WorkflowParameter AWS CloudFormation Resource (AWS::ImageBuilder::ImagePipeline.WorkflowParameter)
...
func (r *ImagePipeline_WorkflowParameter) AWSCloudFormationType() string {
	return "AWS::ImageBuilder::ImagePipeline.WorkflowParameter"
}
