...
func (t *CloudFormationTemplate) GetAllAWSCodeBuildProjectResources () map[string]AWSCodeBuildProject {
...
func (t *CloudFormationTemplate) GetAWSCodeBuildProjectWithName (name string) (AWSCodeBuildProject, error) {
