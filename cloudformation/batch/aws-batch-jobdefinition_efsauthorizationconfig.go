...
// JobDefinition_EFSAuthorizationConfig AWS CloudFormation Resource (AWS::Batch::JobDefinition.EFSAuthorizationConfig)
...
func (r *JobDefinition_EFSAuthorizationConfig) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.EFSAuthorizationConfig"
}
