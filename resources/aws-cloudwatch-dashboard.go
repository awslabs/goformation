...
func (t *CloudFormationTemplate) GetAllAWSCloudWatchDashboardResources () map[string]AWSCloudWatchDashboard {
...
func (t *CloudFormationTemplate) GetAWSCloudWatchDashboardWithName (name string) (AWSCloudWatchDashboard, error) {
