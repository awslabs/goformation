...
// OrganizationConfiguration AWS CloudFormation Resource (AWS::SecurityHub::OrganizationConfiguration)
...
type OrganizationConfiguration struct {
	...
	// AutoEnable AWS CloudFormation Property
	// Required: true
	...
	// AutoEnableStandards AWS CloudFormation Property
	// Required: false
...
func (r *OrganizationConfiguration) AWSCloudFormationType() string {
	return "AWS::SecurityHub::OrganizationConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationConfiguration) MarshalJSON() ([]byte, error) {
	type Properties OrganizationConfiguration
...
func (r *OrganizationConfiguration) UnmarshalJSON(b []byte) error {
	type Properties OrganizationConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OrganizationConfiguration(*res.Properties)
	}
