...
// FlowVersion_PromptInputVariable AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.PromptInputVariable)
...
func (r *FlowVersion_PromptInputVariable) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.PromptInputVariable"
}
