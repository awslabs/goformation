...
type AWSEC2SpotFleetInstanceNetworkInterfaceSpecification struct {
    ...
    Ipv6Addresses []AWSEC2SpotFleetInstanceNetworkInterfaceSpecificationInstanceIpv6Address `json:"Ipv6Addresses"`
    ...
    PrivateIpAddresses []AWSEC2SpotFleetInstanceNetworkInterfaceSpecificationPrivateIpAddressSpecification `json:"PrivateIpAddresses"`
...
func (r *AWSEC2SpotFleetInstanceNetworkInterfaceSpecification) AWSCloudFormationType() string {
    return "AWS::EC2::SpotFleet.InstanceNetworkInterfaceSpecification"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSEC2SpotFleetInstanceNetworkInterfaceSpecification) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}