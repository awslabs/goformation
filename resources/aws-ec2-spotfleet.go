...
func (t *CloudFormationTemplate) GetAllAWSEC2SpotFleetResources () map[string]AWSEC2SpotFleet {
...
func (t *CloudFormationTemplate) GetAWSEC2SpotFleetWithName (name string) (AWSEC2SpotFleet, error) {
