...
func (t *CloudFormationTemplate) GetAllAWSRDSDBInstanceResources() map[string]AWSRDSDBInstance {
...
func (t *CloudFormationTemplate) GetAWSRDSDBInstanceWithName(name string) (AWSRDSDBInstance, error) {
