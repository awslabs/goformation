...
// FeatureGroup_TtlDuration AWS CloudFormation Resource (AWS::SageMaker::FeatureGroup.TtlDuration)
...
func (r *FeatureGroup_TtlDuration) AWSCloudFormationType() string {
	return "AWS::SageMaker::FeatureGroup.TtlDuration"
}
