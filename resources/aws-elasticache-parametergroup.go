...
func (t *CloudFormationTemplate) GetAllAWSElastiCacheParameterGroupResources() map[string]AWSElastiCacheParameterGroup {
...
func (t *CloudFormationTemplate) GetAWSElastiCacheParameterGroupWithName(name string) (AWSElastiCacheParameterGroup, error) {
