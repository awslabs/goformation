...
// Pipe_CloudwatchLogsLogDestination AWS CloudFormation Resource (AWS::Pipes::Pipe.CloudwatchLogsLogDestination)
...
func (r *Pipe_CloudwatchLogsLogDestination) AWSCloudFormationType() string {
	return "AWS::Pipes::Pipe.CloudwatchLogsLogDestination"
}
