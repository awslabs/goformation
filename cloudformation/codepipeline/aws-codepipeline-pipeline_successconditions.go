...
// Pipeline_SuccessConditions AWS CloudFormation Resource (AWS::CodePipeline::Pipeline.SuccessConditions)
...
func (r *Pipeline_SuccessConditions) AWSCloudFormationType() string {
	return "AWS::CodePipeline::Pipeline.SuccessConditions"
}
