...
// FlowVersion_FlowConditionalConnectionConfiguration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.FlowConditionalConnectionConfiguration)
...
func (r *FlowVersion_FlowConditionalConnectionConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.FlowConditionalConnectionConfiguration"
}
