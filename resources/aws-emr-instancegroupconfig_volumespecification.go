...
type AWSEMRInstanceGroupConfigVolumeSpecification struct {
...
func (r *AWSEMRInstanceGroupConfigVolumeSpecification) AWSCloudFormationType() string {
    return "AWS::EMR::InstanceGroupConfig.VolumeSpecification"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSEMRInstanceGroupConfigVolumeSpecification) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}