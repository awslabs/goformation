...
// UserProfile_CustomPosixUserConfig AWS CloudFormation Resource (AWS::SageMaker::UserProfile.CustomPosixUserConfig)
...
func (r *UserProfile_CustomPosixUserConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::UserProfile.CustomPosixUserConfig"
}
