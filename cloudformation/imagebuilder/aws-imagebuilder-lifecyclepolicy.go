...
// LifecyclePolicy AWS CloudFormation Resource (AWS::ImageBuilder::LifecyclePolicy)
...
type LifecyclePolicy struct {
	...
	PolicyDetails []LifecyclePolicy_PolicyDetail `json:"PolicyDetails"`
	...
	ResourceSelection *LifecyclePolicy_ResourceSelection `json:"ResourceSelection"`
