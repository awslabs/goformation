...
func (r *ChannelGroup) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::ChannelGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ChannelGroup) MarshalJSON() ([]byte, error) {
	type Properties ChannelGroup
...
func (r *ChannelGroup) UnmarshalJSON(b []byte) error {
	type Properties ChannelGroup
	res := &struct {
		Type                string
		Properties          *Properties
