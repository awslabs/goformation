...
// MailManagerRuleSet_RuleIpToEvaluate AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.RuleIpToEvaluate)
...
func (r *MailManagerRuleSet_RuleIpToEvaluate) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.RuleIpToEvaluate"
}
