...
// DataLake_EncryptionConfiguration AWS CloudFormation Resource (AWS::SecurityLake::DataLake.EncryptionConfiguration)
...
func (r *DataLake_EncryptionConfiguration) AWSCloudFormationType() string {
	return "AWS::SecurityLake::DataLake.EncryptionConfiguration"
}
