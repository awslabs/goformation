...
// Subscriber_CustomLogSource AWS CloudFormation Resource (AWS::SecurityLake::Subscriber.CustomLogSource)
...
func (r *Subscriber_CustomLogSource) AWSCloudFormationType() string {
	return "AWS::SecurityLake::Subscriber.CustomLogSource"
}
