...
func (r *IdentityPoolPrincipalTag) AWSCloudFormationType() string {
	return "AWS::Cognito::IdentityPoolPrincipalTag"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentityPoolPrincipalTag) MarshalJSON() ([]byte, error) {
	type Properties IdentityPoolPrincipalTag
...
func (r *IdentityPoolPrincipalTag) UnmarshalJSON(b []byte) error {
	type Properties IdentityPoolPrincipalTag
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IdentityPoolPrincipalTag(*res.Properties)
	}
