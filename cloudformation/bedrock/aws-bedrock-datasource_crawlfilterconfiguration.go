...
// DataSource_CrawlFilterConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.CrawlFilterConfiguration)
...
type DataSource_CrawlFilterConfiguration struct {
	...
	// PatternObjectFilter AWS CloudFormation Property
	// Required: false
...
func (r *DataSource_CrawlFilterConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.CrawlFilterConfiguration"
}
