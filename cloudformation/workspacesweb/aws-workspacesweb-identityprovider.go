...
func (r *IdentityProvider) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::IdentityProvider"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentityProvider) MarshalJSON() ([]byte, error) {
	type Properties IdentityProvider
...
func (r *IdentityProvider) UnmarshalJSON(b []byte) error {
	type Properties IdentityProvider
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IdentityProvider(*res.Properties)
	}
