...
func (r *ChannelPolicy) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::ChannelPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ChannelPolicy) MarshalJSON() ([]byte, error) {
	type Properties ChannelPolicy
...
func (r *ChannelPolicy) UnmarshalJSON(b []byte) error {
	type Properties ChannelPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ChannelPolicy(*res.Properties)
	}
