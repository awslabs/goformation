...
func (t *CloudFormationTemplate) GetAllAWSOpsWorksInstanceResources() map[string]AWSOpsWorksInstance {
...
func (t *CloudFormationTemplate) GetAWSOpsWorksInstanceWithName(name string) (AWSOpsWorksInstance, error) {
