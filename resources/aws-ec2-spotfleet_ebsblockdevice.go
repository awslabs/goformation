...
type AWSEC2SpotFleetEbsBlockDevice struct {
...
func (r *AWSEC2SpotFleetEbsBlockDevice) AWSCloudFormationType() string {
    return "AWS::EC2::SpotFleet.EbsBlockDevice"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSEC2SpotFleetEbsBlockDevice) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}