...
func (t *CloudFormationTemplate) GetAllAWSRDSDBClusterResources() map[string]AWSRDSDBCluster {
...
func (t *CloudFormationTemplate) GetAWSRDSDBClusterWithName(name string) (AWSRDSDBCluster, error) {
