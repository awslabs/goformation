...
func GetAllAWSCognitoUserPoolClient(template *Template) map[string]*AWSCognitoUserPoolClient {
...
func GetWithNameAWSCognitoUserPoolClient(name string, template *Template) (*AWSCognitoUserPoolClient, error) {
