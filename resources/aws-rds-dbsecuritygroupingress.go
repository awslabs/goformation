...
func (t *CloudFormationTemplate) GetAllAWSRDSDBSecurityGroupIngressResources () map[string]AWSRDSDBSecurityGroupIngress {
...
func (t *CloudFormationTemplate) GetAWSRDSDBSecurityGroupIngressWithName (name string) (AWSRDSDBSecurityGroupIngress, error) {
