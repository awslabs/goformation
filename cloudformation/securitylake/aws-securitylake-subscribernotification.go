...
// SubscriberNotification AWS CloudFormation Resource (AWS::SecurityLake::SubscriberNotification)
...
type SubscriberNotification struct {
	...
	NotificationConfiguration *SubscriberNotification_NotificationConfiguration `json:"NotificationConfiguration"`

	// SubscriberArn AWS CloudFormation Property
	// Required: true
	...
	SubscriberArn string `json:"SubscriberArn"`
...
func (r *SubscriberNotification) AWSCloudFormationType() string {
	return "AWS::SecurityLake::SubscriberNotification"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SubscriberNotification) MarshalJSON() ([]byte, error) {
	type Properties SubscriberNotification
...
func (r *SubscriberNotification) UnmarshalJSON(b []byte) error {
	type Properties SubscriberNotification
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SubscriberNotification(*res.Properties)
	}
