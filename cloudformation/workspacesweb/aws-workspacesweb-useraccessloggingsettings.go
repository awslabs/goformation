...
func (r *UserAccessLoggingSettings) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::UserAccessLoggingSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r UserAccessLoggingSettings) MarshalJSON() ([]byte, error) {
	type Properties UserAccessLoggingSettings
...
func (r *UserAccessLoggingSettings) UnmarshalJSON(b []byte) error {
	type Properties UserAccessLoggingSettings
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = UserAccessLoggingSettings(*res.Properties)
	}
