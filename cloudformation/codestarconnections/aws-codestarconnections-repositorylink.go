...
// RepositoryLink AWS CloudFormation Resource (AWS::CodeStarConnections::RepositoryLink)
...
func (r *RepositoryLink) AWSCloudFormationType() string {
	return "AWS::CodeStarConnections::RepositoryLink"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RepositoryLink) MarshalJSON() ([]byte, error) {
	type Properties RepositoryLink
...
func (r *RepositoryLink) UnmarshalJSON(b []byte) error {
	type Properties RepositoryLink
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RepositoryLink(*res.Properties)
	}
