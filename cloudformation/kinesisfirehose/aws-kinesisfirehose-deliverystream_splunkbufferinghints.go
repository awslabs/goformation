...
// DeliveryStream_SplunkBufferingHints AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.SplunkBufferingHints)
...
func (r *DeliveryStream_SplunkBufferingHints) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.SplunkBufferingHints"
}
