...
// Domain_ColdStorageOptions AWS CloudFormation Resource (AWS::OpenSearchService::Domain.ColdStorageOptions)
...
func (r *Domain_ColdStorageOptions) AWSCloudFormationType() string {
	return "AWS::OpenSearchService::Domain.ColdStorageOptions"
}
