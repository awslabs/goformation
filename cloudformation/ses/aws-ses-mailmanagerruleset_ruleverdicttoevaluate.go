...
// MailManagerRuleSet_RuleVerdictToEvaluate AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.RuleVerdictToEvaluate)
...
func (r *MailManagerRuleSet_RuleVerdictToEvaluate) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.RuleVerdictToEvaluate"
}
