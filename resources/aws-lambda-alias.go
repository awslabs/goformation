...
func (t *CloudFormationTemplate) GetAllAWSLambdaAliasResources() map[string]AWSLambdaAlias {
...
func (t *CloudFormationTemplate) GetAWSLambdaAliasWithName(name string) (AWSLambdaAlias, error) {
