...
type AWSApiGatewayStageMethodSetting struct {
...
func (r *AWSApiGatewayStageMethodSetting) AWSCloudFormationType() string {
	return "AWS::ApiGateway::Stage.MethodSetting"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSApiGatewayStageMethodSetting) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
