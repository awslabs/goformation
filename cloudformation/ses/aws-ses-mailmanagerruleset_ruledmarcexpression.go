...
// MailManagerRuleSet_RuleDmarcExpression AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.RuleDmarcExpression)
...
func (r *MailManagerRuleSet_RuleDmarcExpression) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.RuleDmarcExpression"
}
