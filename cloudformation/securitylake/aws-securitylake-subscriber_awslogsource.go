...
// Subscriber_AwsLogSource AWS CloudFormation Resource (AWS::SecurityLake::Subscriber.AwsLogSource)
...
func (r *Subscriber_AwsLogSource) AWSCloudFormationType() string {
	return "AWS::SecurityLake::Subscriber.AwsLogSource"
}
