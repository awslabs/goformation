...
// Template_DefaultRelativeDateTimeControlOptions AWS CloudFormation Resource (AWS::QuickSight::Template.DefaultRelativeDateTimeControlOptions)
...
func (r *Template_DefaultRelativeDateTimeControlOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.DefaultRelativeDateTimeControlOptions"
}
