...
type AWSCodePipelineCustomActionTypeSettings struct {
...
func (r *AWSCodePipelineCustomActionTypeSettings) AWSCloudFormationType() string {
	return "AWS::CodePipeline::CustomActionType.Settings"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSCodePipelineCustomActionTypeSettings) AWSCloudFormationSpecificationVersion() string {
	return "1.4.2"
}
