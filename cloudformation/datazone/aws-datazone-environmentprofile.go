...
// EnvironmentProfile AWS CloudFormation Resource (AWS::DataZone::EnvironmentProfile)
...
type EnvironmentProfile struct {
	...
	// AwsAccountRegion AWS CloudFormation Property
	// Required: true
	...
	AwsAccountRegion string `json:"AwsAccountRegion"`
...
func (r *EnvironmentProfile) AWSCloudFormationType() string {
	return "AWS::DataZone::EnvironmentProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EnvironmentProfile) MarshalJSON() ([]byte, error) {
	type Properties EnvironmentProfile
...
func (r *EnvironmentProfile) UnmarshalJSON(b []byte) error {
	type Properties EnvironmentProfile
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EnvironmentProfile(*res.Properties)
	}
