...
func (t *CloudFormationTemplate) GetAllAWSEC2InstanceResources () map[string]AWSEC2Instance {
...
func (t *CloudFormationTemplate) GetAWSEC2InstanceWithName (name string) (AWSEC2Instance, error) {
