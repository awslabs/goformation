...
func (t *CloudFormationTemplate) GetAllAWSEMRInstanceGroupConfigResources () map[string]AWSEMRInstanceGroupConfig {
...
func (t *CloudFormationTemplate) GetAWSEMRInstanceGroupConfigWithName (name string) (AWSEMRInstanceGroupConfig, error) {
