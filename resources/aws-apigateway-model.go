...
func GetAllAWSApiGatewayModel(template *Template) map[string]*AWSApiGatewayModel {
...
func GetWithNameAWSApiGatewayModel(name string, template *Template) (*AWSApiGatewayModel, error) {
