...
// CustomPlugin AWS CloudFormation Resource (AWS::KafkaConnect::CustomPlugin)
...
type CustomPlugin struct {
	...
	Location *CustomPlugin_CustomPluginLocation `json:"Location"`
...
func (r *CustomPlugin) AWSCloudFormationType() string {
	return "AWS::KafkaConnect::CustomPlugin"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CustomPlugin) MarshalJSON() ([]byte, error) {
	type Properties CustomPlugin
...
func (r *CustomPlugin) UnmarshalJSON(b []byte) error {
	type Properties CustomPlugin
	res := &struct {
		Type                string
		Properties          *Properties
