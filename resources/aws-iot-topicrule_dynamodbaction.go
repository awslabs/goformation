...
type AWSIoTTopicRuleDynamoDBAction struct {
...
func (r *AWSIoTTopicRuleDynamoDBAction) AWSCloudFormationType() string {
    return "AWS::IoT::TopicRule.DynamoDBAction"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSIoTTopicRuleDynamoDBAction) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}