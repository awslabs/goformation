...
// Insight_DateRange AWS CloudFormation Resource (AWS::SecurityHub::Insight.DateRange)
...
func (r *Insight_DateRange) AWSCloudFormationType() string {
	return "AWS::SecurityHub::Insight.DateRange"
}
