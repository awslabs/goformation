...
func (t *CloudFormationTemplate) GetAllAWSOpsWorksVolumeResources() map[string]AWSOpsWorksVolume {
...
func (t *CloudFormationTemplate) GetAWSOpsWorksVolumeWithName(name string) (AWSOpsWorksVolume, error) {
