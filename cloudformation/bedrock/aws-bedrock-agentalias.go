...
// AgentAlias AWS CloudFormation Resource (AWS::Bedrock::AgentAlias)
...
type AgentAlias struct {
	...
	// AgentAliasName AWS CloudFormation Property
	// Required: true
	...
	// AgentId AWS CloudFormation Property
	// Required: true
...
func (r *AgentAlias) AWSCloudFormationType() string {
	return "AWS::Bedrock::AgentAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AgentAlias) MarshalJSON() ([]byte, error) {
	type Properties AgentAlias
...
func (r *AgentAlias) UnmarshalJSON(b []byte) error {
	type Properties AgentAlias
	res := &struct {
		Type                string
		Properties          *Properties
