...
func (r *LogDeliveryConfiguration) AWSCloudFormationType() string {
	return "AWS::Cognito::LogDeliveryConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LogDeliveryConfiguration) MarshalJSON() ([]byte, error) {
	type Properties LogDeliveryConfiguration
...
func (r *LogDeliveryConfiguration) UnmarshalJSON(b []byte) error {
	type Properties LogDeliveryConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LogDeliveryConfiguration(*res.Properties)
	}
