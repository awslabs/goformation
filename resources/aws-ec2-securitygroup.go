...
func GetAllAWSEC2SecurityGroupResources(template *Template) map[string]*AWSEC2SecurityGroup {
...
func GetAWSEC2SecurityGroupWithName(name string, template *Template) (*AWSEC2SecurityGroup, error) {
