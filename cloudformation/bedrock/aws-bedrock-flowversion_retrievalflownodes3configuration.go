...
// FlowVersion_RetrievalFlowNodeS3Configuration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.RetrievalFlowNodeS3Configuration)
...
func (r *FlowVersion_RetrievalFlowNodeS3Configuration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.RetrievalFlowNodeS3Configuration"
}
