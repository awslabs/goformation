...
type AWSEC2SpotFleetSpotFleetLaunchSpecification struct {
    ...
    BlockDeviceMappings []AWSEC2SpotFleetSpotFleetLaunchSpecificationBlockDeviceMapping `json:"BlockDeviceMappings"`
    ...
    IamInstanceProfile AWSEC2SpotFleetSpotFleetLaunchSpecificationIamInstanceProfileSpecification `json:"IamInstanceProfile"`
    ...
    Monitoring AWSEC2SpotFleetSpotFleetLaunchSpecificationSpotFleetMonitoring `json:"Monitoring"`
    ...
    NetworkInterfaces []AWSEC2SpotFleetSpotFleetLaunchSpecificationInstanceNetworkInterfaceSpecification `json:"NetworkInterfaces"`
    ...
    Placement AWSEC2SpotFleetSpotFleetLaunchSpecificationSpotPlacement `json:"Placement"`
    ...
    SecurityGroups []AWSEC2SpotFleetSpotFleetLaunchSpecificationGroupIdentifier `json:"SecurityGroups"`
...
func (r *AWSEC2SpotFleetSpotFleetLaunchSpecification) AWSCloudFormationType() string {
    return "AWS::EC2::SpotFleet.SpotFleetLaunchSpecification"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSEC2SpotFleetSpotFleetLaunchSpecification) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}