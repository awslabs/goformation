...
func GetAllAWSWAFRegionalWebACLResources(template *Template) map[string]*AWSWAFRegionalWebACL {
...
func GetAWSWAFRegionalWebACLWithName(name string, template *Template) (*AWSWAFRegionalWebACL, error) {
