...
// Function_CorsConfiguration AWS CloudFormation Resource (AWS::Serverless::Function.CorsConfiguration)
// See: https://github.com/awslabs/serverless-application-model/blob/master/versions/2016-10-31.md#cors-configuration
type Function_CorsConfiguration struct {
...
func (r *Function_CorsConfiguration) AWSCloudFormationType() string {
	return "AWS::Serverless::Function.CorsConfiguration"
}
