...
func (r *SourceApiAssociation) AWSCloudFormationType() string {
	return "AWS::AppSync::SourceApiAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SourceApiAssociation) MarshalJSON() ([]byte, error) {
	type Properties SourceApiAssociation
...
func (r *SourceApiAssociation) UnmarshalJSON(b []byte) error {
	type Properties SourceApiAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SourceApiAssociation(*res.Properties)
	}
