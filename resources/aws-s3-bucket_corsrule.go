...
type AWSS3BucketCorsRule struct {
	...
	AllowedHeaders []AWSS3BucketCorsRulestring `json:"AllowedHeaders"`
	...
	AllowedMethods []AWSS3BucketCorsRulestring `json:"AllowedMethods"`
	...
	AllowedOrigins []AWSS3BucketCorsRulestring `json:"AllowedOrigins"`
	...
	ExposedHeaders []AWSS3BucketCorsRulestring `json:"ExposedHeaders"`
