...
// Flow_PromptInferenceConfiguration AWS CloudFormation Resource (AWS::Bedrock::Flow.PromptInferenceConfiguration)
...
type Flow_PromptInferenceConfiguration struct {
	...
	Text *Flow_PromptModelInferenceConfiguration `json:"Text"`
...
func (r *Flow_PromptInferenceConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.PromptInferenceConfiguration"
}
