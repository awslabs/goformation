...
// FlowVersion_FlowNodeOutput AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.FlowNodeOutput)
...
func (r *FlowVersion_FlowNodeOutput) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.FlowNodeOutput"
}
