...
// StorageProfile AWS CloudFormation Resource (AWS::Deadline::StorageProfile)
...
func (r *StorageProfile) AWSCloudFormationType() string {
	return "AWS::Deadline::StorageProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StorageProfile) MarshalJSON() ([]byte, error) {
	type Properties StorageProfile
...
func (r *StorageProfile) UnmarshalJSON(b []byte) error {
	type Properties StorageProfile
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = StorageProfile(*res.Properties)
	}
