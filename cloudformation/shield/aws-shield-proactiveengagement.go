...
type ProactiveEngagement struct {
	...
	EmergencyContactList []ProactiveEngagement_EmergencyContact `json:"EmergencyContactList"`
...
func (r *ProactiveEngagement) AWSCloudFormationType() string {
	return "AWS::Shield::ProactiveEngagement"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProactiveEngagement) MarshalJSON() ([]byte, error) {
	type Properties ProactiveEngagement
...
func (r *ProactiveEngagement) UnmarshalJSON(b []byte) error {
	type Properties ProactiveEngagement
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProactiveEngagement(*res.Properties)
	}
