...
func GetAllAWSCognitoIdentityPoolResources(template *Template) map[string]*AWSCognitoIdentityPool {
...
func GetAWSCognitoIdentityPoolWithName(name string, template *Template) (*AWSCognitoIdentityPool, error) {
