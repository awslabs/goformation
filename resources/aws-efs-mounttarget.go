...
func (t *CloudFormationTemplate) GetAllAWSEFSMountTargetResources () map[string]AWSEFSMountTarget {
...
func (t *CloudFormationTemplate) GetAWSEFSMountTargetWithName (name string) (AWSEFSMountTarget, error) {
