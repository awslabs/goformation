...
// CloudWatchAlarmTemplateGroup AWS CloudFormation Resource (AWS::MediaLive::CloudWatchAlarmTemplateGroup)
...
func (r *CloudWatchAlarmTemplateGroup) AWSCloudFormationType() string {
	return "AWS::MediaLive::CloudWatchAlarmTemplateGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CloudWatchAlarmTemplateGroup) MarshalJSON() ([]byte, error) {
	type Properties CloudWatchAlarmTemplateGroup
...
func (r *CloudWatchAlarmTemplateGroup) UnmarshalJSON(b []byte) error {
	type Properties CloudWatchAlarmTemplateGroup
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CloudWatchAlarmTemplateGroup(*res.Properties)
	}
