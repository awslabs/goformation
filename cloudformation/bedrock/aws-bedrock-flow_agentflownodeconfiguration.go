...
// Flow_AgentFlowNodeConfiguration AWS CloudFormation Resource (AWS::Bedrock::Flow.AgentFlowNodeConfiguration)
...
func (r *Flow_AgentFlowNodeConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.AgentFlowNodeConfiguration"
}
