...
func (t *CloudFormationTemplate) GetAllAWSLogsLogGroupResources() map[string]AWSLogsLogGroup {
...
func (t *CloudFormationTemplate) GetAWSLogsLogGroupWithName(name string) (AWSLogsLogGroup, error) {
