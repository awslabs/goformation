...
// ProfileAssociation AWS CloudFormation Resource (AWS::Route53Profiles::ProfileAssociation)
...
func (r *ProfileAssociation) AWSCloudFormationType() string {
	return "AWS::Route53Profiles::ProfileAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProfileAssociation) MarshalJSON() ([]byte, error) {
	type Properties ProfileAssociation
...
func (r *ProfileAssociation) UnmarshalJSON(b []byte) error {
	type Properties ProfileAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProfileAssociation(*res.Properties)
	}
