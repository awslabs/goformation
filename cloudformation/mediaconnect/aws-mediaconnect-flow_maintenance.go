...
// Flow_Maintenance AWS CloudFormation Resource (AWS::MediaConnect::Flow.Maintenance)
...
type Flow_Maintenance struct {
	...
	// MaintenanceStartHour AWS CloudFormation Property
	// Required: true
	...
	MaintenanceStartHour string `json:"MaintenanceStartHour"`
...
func (r *Flow_Maintenance) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Flow.Maintenance"
}
