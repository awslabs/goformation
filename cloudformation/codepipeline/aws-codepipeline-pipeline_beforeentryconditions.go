...
// Pipeline_BeforeEntryConditions AWS CloudFormation Resource (AWS::CodePipeline::Pipeline.BeforeEntryConditions)
...
func (r *Pipeline_BeforeEntryConditions) AWSCloudFormationType() string {
	return "AWS::CodePipeline::Pipeline.BeforeEntryConditions"
}
