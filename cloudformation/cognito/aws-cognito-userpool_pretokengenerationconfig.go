...
// UserPool_PreTokenGenerationConfig AWS CloudFormation Resource (AWS::Cognito::UserPool.PreTokenGenerationConfig)
...
func (r *UserPool_PreTokenGenerationConfig) AWSCloudFormationType() string {
	return "AWS::Cognito::UserPool.PreTokenGenerationConfig"
}
