...
// Folder AWS CloudFormation Resource (AWS::QuickSight::Folder)
...
type Folder struct {
	...
	// FolderId AWS CloudFormation Property
	// Required: false
	...
	// ParentFolderArn AWS CloudFormation Property
	// Required: false
	...
	// SharingModel AWS CloudFormation Property
	// Required: false
...
func (r *Folder) AWSCloudFormationType() string {
...
func (r *Folder) UnmarshalJSON(b []byte) error {
	type Properties Folder
	res := &struct {
		Type                string
		Properties          *Properties
