...
// JobDefinition_NodeRangeProperty AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.NodeRangeProperty)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-noderangeproperty.html
...
func (r *JobDefinition_NodeRangeProperty) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.NodeRangeProperty"
}
