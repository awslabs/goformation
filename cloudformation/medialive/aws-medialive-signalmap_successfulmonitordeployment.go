...
// SignalMap_SuccessfulMonitorDeployment AWS CloudFormation Resource (AWS::MediaLive::SignalMap.SuccessfulMonitorDeployment)
...
func (r *SignalMap_SuccessfulMonitorDeployment) AWSCloudFormationType() string {
	return "AWS::MediaLive::SignalMap.SuccessfulMonitorDeployment"
}
