...
// Agent_ParameterDetail AWS CloudFormation Resource (AWS::Bedrock::Agent.ParameterDetail)
...
func (r *Agent_ParameterDetail) AWSCloudFormationType() string {
	return "AWS::Bedrock::Agent.ParameterDetail"
}
