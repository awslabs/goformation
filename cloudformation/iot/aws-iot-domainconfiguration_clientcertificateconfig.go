...
// DomainConfiguration_ClientCertificateConfig AWS CloudFormation Resource (AWS::IoT::DomainConfiguration.ClientCertificateConfig)
...
type DomainConfiguration_ClientCertificateConfig struct {
	...
	// ClientCertificateCallbackArn AWS CloudFormation Property
	// Required: false
...
func (r *DomainConfiguration_ClientCertificateConfig) AWSCloudFormationType() string {
	return "AWS::IoT::DomainConfiguration.ClientCertificateConfig"
}
