...
// DataSource_UrlConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.UrlConfiguration)
...
type DataSource_UrlConfiguration struct {
	...
	SeedUrls []DataSource_SeedUrl `json:"SeedUrls"`
...
func (r *DataSource_UrlConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.UrlConfiguration"
}
