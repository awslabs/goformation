...
// CustomEntityType AWS CloudFormation Resource (AWS::Glue::CustomEntityType)
...
type CustomEntityType struct {
	...
	// ContextWords AWS CloudFormation Property
	// Required: false
...
func (r *CustomEntityType) AWSCloudFormationType() string {
	return "AWS::Glue::CustomEntityType"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CustomEntityType) MarshalJSON() ([]byte, error) {
	type Properties CustomEntityType
...
func (r *CustomEntityType) UnmarshalJSON(b []byte) error {
	type Properties CustomEntityType
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CustomEntityType(*res.Properties)
	}
