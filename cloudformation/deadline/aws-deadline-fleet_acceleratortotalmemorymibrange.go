...
// Fleet_AcceleratorTotalMemoryMiBRange AWS CloudFormation Resource (AWS::Deadline::Fleet.AcceleratorTotalMemoryMiBRange)
...
func (r *Fleet_AcceleratorTotalMemoryMiBRange) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.AcceleratorTotalMemoryMiBRange"
}
