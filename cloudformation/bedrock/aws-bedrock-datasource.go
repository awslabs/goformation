...
// DataSource AWS CloudFormation Resource (AWS::Bedrock::DataSource)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-datasource.html
type DataSource struct {

	// DataDeletionPolicy AWS CloudFormation Property
	// Required: false
	...
	DataSourceConfiguration *DataSource_DataSourceConfiguration `json:"DataSourceConfiguration"`
