...
// FlowVersion AWS CloudFormation Resource (AWS::Bedrock::FlowVersion)
...
func (r *FlowVersion) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FlowVersion) MarshalJSON() ([]byte, error) {
	type Properties FlowVersion
...
func (r *FlowVersion) UnmarshalJSON(b []byte) error {
	type Properties FlowVersion
	res := &struct {
		Type                string
		Properties          *Properties
