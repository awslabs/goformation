...
// JobDefinition_FargatePlatformConfiguration AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.FargatePlatformConfiguration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-containerproperties-fargateplatformconfiguration.html
...
func (r *JobDefinition_FargatePlatformConfiguration) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.FargatePlatformConfiguration"
}
