...
func (r *AWSElasticBeanstalkEnvironmentTier) AWSCloudFormationType() string {
    return "AWS::ElasticBeanstalk::Environment.Tier"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSElasticBeanstalkEnvironmentTier) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}