...
type AWSEMRInstanceGroupConfigCloudWatchAlarmDefinition struct {
    ...
    Dimensions []AWSEMRInstanceGroupConfigCloudWatchAlarmDefinitionMetricDimension `json:"Dimensions"`
...
func (r *AWSEMRInstanceGroupConfigCloudWatchAlarmDefinition) AWSCloudFormationType() string {
    return "AWS::EMR::InstanceGroupConfig.CloudWatchAlarmDefinition"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSEMRInstanceGroupConfigCloudWatchAlarmDefinition) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}