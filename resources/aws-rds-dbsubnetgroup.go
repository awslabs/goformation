...
func (t *CloudFormationTemplate) GetAllAWSRDSDBSubnetGroupResources () map[string]AWSRDSDBSubnetGroup {
...
func (t *CloudFormationTemplate) GetAWSRDSDBSubnetGroupWithName (name string) (AWSRDSDBSubnetGroup, error) {
