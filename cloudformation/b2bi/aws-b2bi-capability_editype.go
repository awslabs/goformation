...
// Capability_EdiType AWS CloudFormation Resource (AWS::B2BI::Capability.EdiType)
...
type Capability_EdiType struct {
	...
	X12Details *Capability_X12Details `json:"X12Details"`
...
func (r *Capability_EdiType) AWSCloudFormationType() string {
	return "AWS::B2BI::Capability.EdiType"
}
