...
func (t *CloudFormationTemplate) GetAllAWSWAFRegionalIPSetResources () map[string]AWSWAFRegionalIPSet {
...
func (t *CloudFormationTemplate) GetAWSWAFRegionalIPSetWithName (name string) (AWSWAFRegionalIPSet, error) {
