...
type Multiplex struct {
	...
	MultiplexSettings *Multiplex_MultiplexSettings `json:"MultiplexSettings"`
...
func (r *Multiplex) AWSCloudFormationType() string {
	return "AWS::MediaLive::Multiplex"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Multiplex) MarshalJSON() ([]byte, error) {
	type Properties Multiplex
...
func (r *Multiplex) UnmarshalJSON(b []byte) error {
	type Properties Multiplex
	res := &struct {
		Type                string
		Properties          *Properties
