...
func (r *AccountPolicy) AWSCloudFormationType() string {
	return "AWS::Logs::AccountPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccountPolicy) MarshalJSON() ([]byte, error) {
	type Properties AccountPolicy
...
func (r *AccountPolicy) UnmarshalJSON(b []byte) error {
	type Properties AccountPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AccountPolicy(*res.Properties)
	}
