...
type AWSEC2SecurityGroup struct {
    ...
    SecurityGroupEgress []AWSEC2SecurityGroupEgress `json:"SecurityGroupEgress"`
    ...
    SecurityGroupIngress []AWSEC2SecurityGroupIngress `json:"SecurityGroupIngress"`
    ...
    Tags []AWSEC2SecurityGroupTag `json:"Tags"`
