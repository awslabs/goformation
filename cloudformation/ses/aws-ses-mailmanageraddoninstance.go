...
// MailManagerAddonInstance AWS CloudFormation Resource (AWS::SES::MailManagerAddonInstance)
...
type MailManagerAddonInstance struct {
	...
	// AddonSubscriptionId AWS CloudFormation Property
	// Required: true
...
func (r *MailManagerAddonInstance) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerAddonInstance"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerAddonInstance) MarshalJSON() ([]byte, error) {
	type Properties MailManagerAddonInstance
...
func (r *MailManagerAddonInstance) UnmarshalJSON(b []byte) error {
	type Properties MailManagerAddonInstance
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerAddonInstance(*res.Properties)
	}
