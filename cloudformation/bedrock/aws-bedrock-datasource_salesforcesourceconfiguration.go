...
// DataSource_SalesforceSourceConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.SalesforceSourceConfiguration)
...
func (r *DataSource_SalesforceSourceConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.SalesforceSourceConfiguration"
}
