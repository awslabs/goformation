...
// TestCase AWS CloudFormation Resource (AWS::AppTest::TestCase)
...
type TestCase struct {
	...
	Steps []TestCase_Step `json:"Steps"`
...
func (r *TestCase) AWSCloudFormationType() string {
	return "AWS::AppTest::TestCase"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TestCase) MarshalJSON() ([]byte, error) {
	type Properties TestCase
...
func (r *TestCase) UnmarshalJSON(b []byte) error {
	type Properties TestCase
	res := &struct {
		Type                string
		Properties          *Properties
