...
func (t *CloudFormationTemplate) GetAllAWSSQSQueuePolicyResources () map[string]AWSSQSQueuePolicy {
...
func (t *CloudFormationTemplate) GetAWSSQSQueuePolicyWithName (name string) (AWSSQSQueuePolicy, error) {
