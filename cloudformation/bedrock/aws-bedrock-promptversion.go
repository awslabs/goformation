...
// PromptVersion AWS CloudFormation Resource (AWS::Bedrock::PromptVersion)
...
func (r *PromptVersion) AWSCloudFormationType() string {
	return "AWS::Bedrock::PromptVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PromptVersion) MarshalJSON() ([]byte, error) {
	type Properties PromptVersion
...
func (r *PromptVersion) UnmarshalJSON(b []byte) error {
	type Properties PromptVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PromptVersion(*res.Properties)
	}
