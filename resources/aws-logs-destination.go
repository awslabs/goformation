...
func (t *CloudFormationTemplate) GetAllAWSLogsDestinationResources() map[string]AWSLogsDestination {
...
func (t *CloudFormationTemplate) GetAWSLogsDestinationWithName(name string) (AWSLogsDestination, error) {
