...
func (t *CloudFormationTemplate) GetAllAWSEC2VolumeAttachmentResources () map[string]AWSEC2VolumeAttachment {
...
func (t *CloudFormationTemplate) GetAWSEC2VolumeAttachmentWithName (name string) (AWSEC2VolumeAttachment, error) {
