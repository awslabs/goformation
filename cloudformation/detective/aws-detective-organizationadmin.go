...
func (r *OrganizationAdmin) AWSCloudFormationType() string {
	return "AWS::Detective::OrganizationAdmin"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationAdmin) MarshalJSON() ([]byte, error) {
	type Properties OrganizationAdmin
...
func (r *OrganizationAdmin) UnmarshalJSON(b []byte) error {
	type Properties OrganizationAdmin
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OrganizationAdmin(*res.Properties)
	}
