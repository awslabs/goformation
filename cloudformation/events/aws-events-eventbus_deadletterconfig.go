...
// EventBus_DeadLetterConfig AWS CloudFormation Resource (AWS::Events::EventBus.DeadLetterConfig)
...
func (r *EventBus_DeadLetterConfig) AWSCloudFormationType() string {
	return "AWS::Events::EventBus.DeadLetterConfig"
}
