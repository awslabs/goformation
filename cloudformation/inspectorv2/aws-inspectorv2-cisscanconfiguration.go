...
// CisScanConfiguration AWS CloudFormation Resource (AWS::InspectorV2::CisScanConfiguration)
...
func (r *CisScanConfiguration) AWSCloudFormationType() string {
	return "AWS::InspectorV2::CisScanConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CisScanConfiguration) MarshalJSON() ([]byte, error) {
	type Properties CisScanConfiguration
...
func (r *CisScanConfiguration) UnmarshalJSON(b []byte) error {
	type Properties CisScanConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CisScanConfiguration(*res.Properties)
	}
