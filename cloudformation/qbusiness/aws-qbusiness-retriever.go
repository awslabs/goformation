...
// Retriever AWS CloudFormation Resource (AWS::QBusiness::Retriever)
...
type Retriever struct {
	...
	Configuration *Retriever_RetrieverConfiguration `json:"Configuration"`
...
func (r *Retriever) AWSCloudFormationType() string {
...
func (r *Retriever) UnmarshalJSON(b []byte) error {
	type Properties Retriever
	res := &struct {
		Type                string
		Properties          *Properties
