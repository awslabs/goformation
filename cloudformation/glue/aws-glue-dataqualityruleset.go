...
func (r *DataQualityRuleset) AWSCloudFormationType() string {
	return "AWS::Glue::DataQualityRuleset"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataQualityRuleset) MarshalJSON() ([]byte, error) {
	type Properties DataQualityRuleset
...
func (r *DataQualityRuleset) UnmarshalJSON(b []byte) error {
	type Properties DataQualityRuleset
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DataQualityRuleset(*res.Properties)
	}
