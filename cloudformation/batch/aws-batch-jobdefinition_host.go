...
// JobDefinition_Host AWS CloudFormation Resource (AWS::Batch::JobDefinition.Host)
...
func (r *JobDefinition_Host) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.Host"
}
