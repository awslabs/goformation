...
// StorageConfiguration AWS CloudFormation Resource (AWS::IVS::StorageConfiguration)
...
type StorageConfiguration struct {
	...
	S3 *StorageConfiguration_S3StorageConfiguration `json:"S3"`
...
func (r *StorageConfiguration) AWSCloudFormationType() string {
	return "AWS::IVS::StorageConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StorageConfiguration) MarshalJSON() ([]byte, error) {
	type Properties StorageConfiguration
...
func (r *StorageConfiguration) UnmarshalJSON(b []byte) error {
	type Properties StorageConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = StorageConfiguration(*res.Properties)
	}
