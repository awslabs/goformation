...
type LiveSource struct {
	...
	HttpPackageConfigurations []LiveSource_HttpPackageConfiguration `json:"HttpPackageConfigurations"`
...
func (r *LiveSource) AWSCloudFormationType() string {
	return "AWS::MediaTailor::LiveSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LiveSource) MarshalJSON() ([]byte, error) {
	type Properties LiveSource
...
func (r *LiveSource) UnmarshalJSON(b []byte) error {
	type Properties LiveSource
	res := &struct {
		Type                string
		Properties          *Properties
