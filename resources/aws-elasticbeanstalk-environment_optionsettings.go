...
type AWSElasticBeanstalkEnvironmentOptionSettings struct {
...
func (r *AWSElasticBeanstalkEnvironmentOptionSettings) AWSCloudFormationType() string {
    return "AWS::ElasticBeanstalk::Environment.OptionSettings"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSElasticBeanstalkEnvironmentOptionSettings) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}