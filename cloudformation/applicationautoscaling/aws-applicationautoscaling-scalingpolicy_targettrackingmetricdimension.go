...
// ScalingPolicy_TargetTrackingMetricDimension AWS CloudFormation Resource (AWS::ApplicationAutoScaling::ScalingPolicy.TargetTrackingMetricDimension)
...
func (r *ScalingPolicy_TargetTrackingMetricDimension) AWSCloudFormationType() string {
	return "AWS::ApplicationAutoScaling::ScalingPolicy.TargetTrackingMetricDimension"
}
