...
// JobDefinition_NodeProperties AWS CloudFormation Resource (AWS::DevBatch::JobDefinition.NodeProperties)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-devbatch-jobdefinition-nodeproperties.html
...
func (r *JobDefinition_NodeProperties) AWSCloudFormationType() string {
	return "AWS::DevBatch::JobDefinition.NodeProperties"
}
