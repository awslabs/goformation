...
// Cluster_InstanceFleetResizingSpecifications AWS CloudFormation Resource (AWS::EMR::Cluster.InstanceFleetResizingSpecifications)
...
func (r *Cluster_InstanceFleetResizingSpecifications) AWSCloudFormationType() string {
	return "AWS::EMR::Cluster.InstanceFleetResizingSpecifications"
}
