...
// MailManagerAddonSubscription AWS CloudFormation Resource (AWS::SES::MailManagerAddonSubscription)
...
func (r *MailManagerAddonSubscription) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerAddonSubscription"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerAddonSubscription) MarshalJSON() ([]byte, error) {
	type Properties MailManagerAddonSubscription
...
func (r *MailManagerAddonSubscription) UnmarshalJSON(b []byte) error {
	type Properties MailManagerAddonSubscription
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerAddonSubscription(*res.Properties)
	}
