...
// ConfigurationPolicy_SecurityControlCustomParameter AWS CloudFormation Resource (AWS::SecurityHub::ConfigurationPolicy.SecurityControlCustomParameter)
...
func (r *ConfigurationPolicy_SecurityControlCustomParameter) AWSCloudFormationType() string {
	return "AWS::SecurityHub::ConfigurationPolicy.SecurityControlCustomParameter"
}
