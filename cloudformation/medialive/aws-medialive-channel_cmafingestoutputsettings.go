...
// Channel_CmafIngestOutputSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.CmafIngestOutputSettings)
...
func (r *Channel_CmafIngestOutputSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.CmafIngestOutputSettings"
}
