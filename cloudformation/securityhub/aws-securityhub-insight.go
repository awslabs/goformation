...
// Insight AWS CloudFormation Resource (AWS::SecurityHub::Insight)
...
type Insight struct {
	...
	Filters *Insight_AwsSecurityFindingFilters `json:"Filters"`

	// GroupByAttribute AWS CloudFormation Property
	// Required: true
...
func (r *Insight) AWSCloudFormationType() string {
	return "AWS::SecurityHub::Insight"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Insight) MarshalJSON() ([]byte, error) {
	type Properties Insight
...
func (r *Insight) UnmarshalJSON(b []byte) error {
	type Properties Insight
	res := &struct {
		Type                string
		Properties          *Properties
