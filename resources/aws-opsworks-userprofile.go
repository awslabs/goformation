...
func (t *CloudFormationTemplate) GetAllAWSOpsWorksUserProfileResources () map[string]AWSOpsWorksUserProfile {
...
func (t *CloudFormationTemplate) GetAWSOpsWorksUserProfileWithName (name string) (AWSOpsWorksUserProfile, error) {
