...
// Partnership_X12FunctionalGroupHeaders AWS CloudFormation Resource (AWS::B2BI::Partnership.X12FunctionalGroupHeaders)
...
type Partnership_X12FunctionalGroupHeaders struct {
	...
	// ApplicationReceiverCode AWS CloudFormation Property
	// Required: false
	...
	// ApplicationSenderCode AWS CloudFormation Property
	// Required: false
	...
	// ResponsibleAgencyCode AWS CloudFormation Property
	// Required: false
...
func (r *Partnership_X12FunctionalGroupHeaders) AWSCloudFormationType() string {
	return "AWS::B2BI::Partnership.X12FunctionalGroupHeaders"
}
