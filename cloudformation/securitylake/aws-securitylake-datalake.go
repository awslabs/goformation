...
// DataLake AWS CloudFormation Resource (AWS::SecurityLake::DataLake)
...
type DataLake struct {
	...
	// MetaStoreManagerRoleArn AWS CloudFormation Property
	// Required: false
...
func (r *DataLake) AWSCloudFormationType() string {
	return "AWS::SecurityLake::DataLake"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataLake) MarshalJSON() ([]byte, error) {
	type Properties DataLake
...
func (r *DataLake) UnmarshalJSON(b []byte) error {
	type Properties DataLake
	res := &struct {
		Type                string
		Properties          *Properties
