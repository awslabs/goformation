...
// Cluster_OnDemandCapacityReservationOptions AWS CloudFormation Resource (AWS::EMR::Cluster.OnDemandCapacityReservationOptions)
...
func (r *Cluster_OnDemandCapacityReservationOptions) AWSCloudFormationType() string {
	return "AWS::EMR::Cluster.OnDemandCapacityReservationOptions"
}
