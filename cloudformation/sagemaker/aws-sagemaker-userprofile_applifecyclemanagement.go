...
// UserProfile_AppLifecycleManagement AWS CloudFormation Resource (AWS::SageMaker::UserProfile.AppLifecycleManagement)
...
type UserProfile_AppLifecycleManagement struct {
	...
	IdleSettings *UserProfile_IdleSettings `json:"IdleSettings,omitempty"`
...
func (r *UserProfile_AppLifecycleManagement) AWSCloudFormationType() string {
	return "AWS::SageMaker::UserProfile.AppLifecycleManagement"
}
