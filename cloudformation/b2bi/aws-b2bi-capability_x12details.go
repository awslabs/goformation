...
// Capability_X12Details AWS CloudFormation Resource (AWS::B2BI::Capability.X12Details)
...
func (r *Capability_X12Details) AWSCloudFormationType() string {
	return "AWS::B2BI::Capability.X12Details"
}
