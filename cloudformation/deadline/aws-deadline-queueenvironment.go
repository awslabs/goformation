...
// QueueEnvironment AWS CloudFormation Resource (AWS::Deadline::QueueEnvironment)
...
func (r *QueueEnvironment) AWSCloudFormationType() string {
	return "AWS::Deadline::QueueEnvironment"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r QueueEnvironment) MarshalJSON() ([]byte, error) {
	type Properties QueueEnvironment
...
func (r *QueueEnvironment) UnmarshalJSON(b []byte) error {
	type Properties QueueEnvironment
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = QueueEnvironment(*res.Properties)
	}
