...
func GetAllAWSBatchJobDefinition(template *Template) map[string]*AWSBatchJobDefinition {
...
func GetWithNameAWSBatchJobDefinition(name string, template *Template) (*AWSBatchJobDefinition, error) {
