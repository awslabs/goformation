...
// Environment AWS CloudFormation Resource (AWS::WorkSpacesThinClient::Environment)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesthinclient-environment.html
type Environment struct {

	// DesiredSoftwareSetId AWS CloudFormation Property
	// Required: false
	...
	DesktopArn string `json:"DesktopArn"`

	// DesktopEndpoint AWS CloudFormation Property
	// Required: false
	...
	// DeviceCreationTags AWS CloudFormation Property
	// Required: false
	...
	DeviceCreationTags []tags.Tag `json:"DeviceCreationTags,omitempty"`
	...
	// SoftwareSetUpdateMode AWS CloudFormation Property
	// Required: false
	...
	// SoftwareSetUpdateSchedule AWS CloudFormation Property
	// Required: false
