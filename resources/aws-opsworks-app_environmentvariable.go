...
type AWSOpsWorksAppEnvironmentVariable struct {
...
func (r *AWSOpsWorksAppEnvironmentVariable) AWSCloudFormationType() string {
    return "AWS::OpsWorks::App.EnvironmentVariable"
}

// AWSCloudFormationSpecificationVersion returns the AWS Specification Version that this resource was generated from
func (r *AWSOpsWorksAppEnvironmentVariable) AWSCloudFormationSpecificationVersion() string {
    return "1.4.2"
}